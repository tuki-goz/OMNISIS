...
<html>
    ...
    <body>
        ...
        <%            File reportfile = new File(application.getRealPath("informeContratosFecha.jasper"));

            Map<String, Object> parameter = new HashMap<String, Object>();

            String valor1 = (request.getParameter("fechainitxt"));
            String valor2 = (request.getParameter("fechafintxt"));
            String valor = (request.getParameter("txtusuario"));
            parameter.put("usuario", new Integer(valor));
