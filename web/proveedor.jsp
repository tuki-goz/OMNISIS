                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        <div class="page-header-title">
                                            <h1 class="m-b-10">Registrar de nuevo Proveedor</h1>
                                        </div>
                                        <div class="page-header-title">
                                            <h5 class="m-b-10"></h5>
                                        </div>
                                                ...
                                                <form action="proveedor" method="POST"> 
                                                    <div class="row">
                                                        <div class="col-3 text-center"> 
                                                            <label for="card-holder" class="text-capitalize">Nombre</label> 
                                                            <% if (prov.getNom_prov() != null) {%> 
                                                            <input id="card-holder" type="text" name="nombretxt" class="form-control" aria-label="Card Holder" placeholder="Ej: Easytrack" aria-describedby="basic-addon1"  title="Easytrack" id="nombre" autofocus value="<%= prov.getNom_prov()%>">
                                                            <%  } else {%>
                                                            <input id="card-holder" type="text" name="nombretxt" class="form-control" aria-label="Card Holder" placeholder="Ej: Easytrack" aria-describedby="basic-addon1"  title="Easytrack" id="nombre" value="" autofocus>
                                                            <% }%> 
                                                            <input id="card-holder" type="hidden" name="idtxt" class="form-control" aria-label="Card Holder" aria-describedby="basic-addon1" value="<%= prov.getId_prov()%>">
                                                        </div>
                                                        <div class="col-3 text-center"> 
                                                            <label for="card-holder" class="text-capitalize">Documento</label>                                                                    
                                                            <% if (prov.getRuc_prov() != null) {%> 
                                                            <input id="card-holder" type="text" name="ructxt" class="form-control" aria-label="Card Holder" placeholder="Ej: 1234567-1" aria-describedby="basic-addon1"  title="1234567-1" id="ruc" value="<%= prov.getRuc_prov()%>">
                                                            <%  } else {%>
                                                            <input id="card-holder" type="text" name="ructxt" class="form-control" aria-label="Card Holder" placeholder="Ej: 1234567-1" aria-describedby="basic-addon1"  title="1234567-1" id="ruc" value="">
                                                            <% }%>
                                                        </div>
                                                        <div class="col-3 text-center"> 
                                                            <label for="card-holder" class="text-capitalize">Teléfono</label>
                                                            <% if (prov.getTel_prov() != null) {%> 
                                                            &nbsp;&nbsp;&nbsp;<input id="card-holder" type="text" name="teltxt" class="form-control" aria-label="Card Holder" placeholder="Ej: +523336562837" aria-describedby="basic-addon1"  title="+52333656-2837" id="telefono" value="<%= prov.getTel_prov()%>">
                                                            <%  } else {%>
                                                            &nbsp;&nbsp;&nbsp;<input id="card-holder" type="text" name="teltxt" class="form-control" aria-label="Card Holder" placeholder="Ej: +523336562837" aria-describedby="basic-addon1"  title="+52333656-2837" id="telefono" value="">
                                                            <% }%>
                                                        </div>
                                                        <div class="col-3 text-center"> 
                                                            <label for="card-holder" class="text-capitalize">Procedencia</label>
                                                            <% if (prov.getProc_prov()!= null) {%> 
                                                            <input id="card-holder" type="text" name="proctxt" class="form-control" aria-label="Card Holder" placeholder="Ej: México" aria-describedby="basic-addon1" pattern="[a-z0-9_-.+]{3,}" title="México" id="direccion" value="<%= prov.getProc_prov()%>">
                                                            <%  } else {%>
                                                            <input id="card-holder" type="text" name="proctxt" class="form-control" aria-label="Card Holder" placeholder="Ej: México" aria-describedby="basic-addon1" pattern="[a-z0-9_-.+]{3,}" title="México" id="direccion" value="">
                                                            <% }%> 
                                                        </div> 
                                                    </div>
                                                    <br>
                                                    <div class="row">
                                                        <div class="col-4 text-center"> 
                                                            <label for="card-holder" class="text-capitalize">Dirección</label>
                                                            <% if (prov.getDir_prov() != null) {%> 
                                                            <input id="card-holder" type="text" name="dirtxt" class="form-control" aria-label="Card Holder" placeholder="Ej: Periférico Norte 767 Col. Santa Margarita, Zapopan, Jalisco" aria-describedby="basic-addon1" pattern="[a-z0-9_-.+]{3,}" title="Periférico Norte 767 Col. Santa Margarita, Zapopan, Jalisco" id="direccion" value="<%= prov.getDir_prov()%>">
                                                            <%  } else {%>
                                                            <input id="card-holder" type="text" name="dirtxt" class="form-control" aria-label="Card Holder" placeholder="Ej: Periférico Norte 767 Col. Santa Margarita, Zapopan, Jalisco" aria-describedby="basic-addon1" pattern="[a-z0-9_-.+]{3,}" title="Periférico Norte 767 Col. Santa Margarita, Zapopan, Jalisco" id="direccion" value="">
                                                            <% }%> 
                                                        </div> 
                                                        <div class="col-4 text-center"> 
                                                            <label for="card-holder" class="text-capitalize">Ciudad</label>
                                                            <select id="drop_ciu" name="drop_ciu" class="form-control" onChange="update()" >                                       
                                                                <%
                                                                    Ciudad ciudad = new Ciudad();
                                                                    HashMap<String, String> drop_ciu = ciudad.seleccionarCiudad();
                                                                    for (String i : drop_ciu.keySet()) {
                                                                        if (prov.getCiu_prov() != null) {
                                                                            if (drop_ciu.get(i).toString().equals(prov.getCiu_prov().toString())) {
                                                                                out.println("<option value='" + i + "' selected>" + drop_ciu.get(i) + "</option>");
                                                                            } else {
                                                                                out.println("<option value='" + i + "'>" + drop_ciu.get(i) + "</option>");
                                                                            }
                                                                        } else {
                                                                            out.println("<option value='" + i + "'>" + drop_ciu.get(i) + "</option>");
                                                                        }
