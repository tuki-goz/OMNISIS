...
<html>
    <head>
        <title>Tipos de Contratos Inactivos</title>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        <div class="page-header-title">
                                            <h3 class="m-b-10">Listado de Tipo de Contratos Inactivos</h3>
                                        </div>                                        
                                    </div>
                                </div>
                            </div>
                                                                    ...
                                                                    <td class="text-center">
                                                                        <div class="container-fluid margin">
                                                                            <form action="tipocontrato" method="POST">  <%-- ubicar el form  action de forma que todo lo que se quiere hacer este afectado, con sus inputs --%>
                                                                                ...
                                                                                <input type="submit" name="accion" target="_blank" class="btn btn-dark action-button" value="Cambiar Activo">
                                                                            </form>                                                                                
                                                                        </div> 
                                                                    </td> 
                                                                </tr>
