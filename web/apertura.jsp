<%-- 
    Document   : apertura
    Created on : 24/09/2021, 08:52:03 PM
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        <div class="page-header-title">
                                            <h1 class="m-b-10">Registrar apertura</h1>
                                        </div>
                                        <div class="page-header-title">
                                            <h5 class="m-b-10"></h5>
                                        </div>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <form action="apertura_cierre" method="POST">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group "> 
                                                                <h5 class="mt-5">Monto Inicial:</h5>
                                                                <input id="card-holder" type="text" name="montoinitxt" class="form-control" aria-label="Card Holder" aria-describedby="basic-addon1" required="true" value="">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="container-fluid margin">                                                        
                                                        <% if (Variables.caja_abierta == 1) {%>
                                                        <button type="button" class="btn btn-dark action-button" data-toggle="modal" data-target="#exampleModalLong">Grabar</button>
                                                        <% } else {%>
