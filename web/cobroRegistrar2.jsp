<%-- 
Document   : cobroRegistrar
Created on : 27/09/2021, 12:34:10 AM
...
<html>
    ...
    <body>
        ...
        <%@ page import="model.Cobro, java.util.ArrayList"%>
        <%@ page import="controller.cobro"%>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        <div class="page-header-title">
                                            <h3 class="m-b-10">Registrar Nuevo Cobro</h3>
                                        </div>                                        
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">                                 
                                    ...
                                    <div class="col-xl-12">
                                        <div class="card">
                                                ...
                                                <form action="cobro" method="POST">
                                                    ...
                                                    <div class="row">     
                                                        ...
                                                        <div class="col-4 text-center">                                                                                                                               
                                                            ...
                                                            <input id="card-holder" type="text" name="idcajatxt" class="form-control" aria-label="Card Holder" aria-describedby="basic-addon1" value="<%= cob.getId_caja()%>">          
                                                            <% }%>
                                                        </div> 
                                                        <div class="col-4 text-center"> 
                                                            <label for="card-holder">Forma de cobro</label>
                                                            <select id="drop_fc" name="drop_fc" class="form-control" onChange="update()" >
                                                                <%
                                                                    Forma_cobro fc = new Forma_cobro();
                                                                    HashMap<String, String> drop = fc.seleccionarFormaCobro();
                                                                    for (String i : drop.keySet()) {
                                                                        if (fc.getDescrip_forma_cobro() != null) {
                                                                            if (drop.get(i).toString().equals(fc.getDescrip_forma_cobro().toString())) {
                                            ...
                                            <br>
                                            <div>
                                                <nav class="navbar navbar-dark navbar-expand-md navigation-clean-search center">
                                                    <ul class="nav navbar-nav">
                                                        <form action="cobro" method="POST">
                                                            <input type="submit" name="accion" target="_blank" class="btn btn-dark btn-icon-split" value="Guardar">
