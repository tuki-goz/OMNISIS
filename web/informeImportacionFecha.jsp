<%-- 
    Document   : informeImportacionFecha
    Created on : 13/12/2021, 09:38:27 PM
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        <div class="page-header-title">
                                            <h3 class="m-b-10">Informe de Importaciones por Fecha</h3>
                                        </div>                                        
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-xl-12">
                                        <div class="card">
                                            <div class="card-header">
                                                <hr>
                                                <div class="col-6">
                                                    <form name="form1" action="pdfImportFecha.jsp" target="_blank" method="post"> 
                                                        <div class="col-8">
