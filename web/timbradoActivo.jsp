<%-- 
    Document   : timbradoActivo
    Created on : 31/10/2021, 04:53:10 PM
...
<html>
    ...
    <body>
        <%@ page import="model.Timbrado, java.util.ArrayList"  %>
        <%@ page import="controller.timbrado"  %>
        <%            ArrayList<Timbrado> AA = null;
            AA = (ArrayList<Timbrado>) request.getAttribute("TimbradoL");
        %>  
        <div class="loader-bg">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        <div class="page-header-title">
                                            <h3 class="m-b-10">Listado de Timbrado Activos</h3>
                                        </div>                                        
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="card">
                                            ...
                                            <div>
                                                ...
                                                <div class="alert alert-secondary alert-dismissible fade show text-center" role="alert" style="float: top;">
                                                    <strong>Genial!</strong> Ha sido modificado.
                                                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                                        Ok
                                                    </button>
                                                </div>
                                            ...
                                            <div>
                                                <%            if (Variables.mensajeRegistrado == 3) {
                                                %>
                                                <div class="alert alert-secondary alert-dismissible fade show text-center" role="alert" style="float: top;">
                                                    <strong>Genial!</strong> Ha sido activado.
                                                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                                        Ok
                                                    </button>
                                                </div>
                                                            ...
                                                            <table class="table table-hover">
                                                                <thead>
                                                                    <tr>
                                                                        ...
                                                                        <th class="text-center">Número Timbrado:</th>
                                                                        <th class="text-center">Inicio de Vigencia:</th>
                                                                        <th class="text-center">Fin de Vigencia:</th>
                                                                ...
                                                                %> 
                                                                <%
                                                                    for (Timbrado timbradoLL : AA) {
                                                                %>                                            
                                                                <tr>  
                                                                    <td class="text-center"> 
                                                                        <%= timbradoLL.getId_tim()%>
                                                                    </td>
                                                                    <td class="text-center"> 
                                                                        <%= timbradoLL.getNro_tim()%>
                                                                    </td>                                          
                                                                    <td class="text-center"> 
                                                                        <%= timbradoLL.getIni_vigen_tim()%>
                                                                    </td>                                 
                                                                    <td class="text-center"> 
                                                                        <%= timbradoLL.getFin_vigen_tim()%>
                                                                    </td>                                 
                                                                    <td class="text-center"> 
                                                                        <%= timbradoLL.getUltimo_nro_tim()%>
                                                                    </td>                                 
                                                                    <td class="text-center"> 
                                                                        <%= timbradoLL.getEstado_tim()%>
                                                                    </td>                                 
                                                                    <td class="text-center">
                                                                        <div class="container-fluid margin">
                                                                            <form action="timbrado" method="POST">  <%-- ubicar el form  action de forma que todo lo que se quiere hacer este afectado, con sus inputs --%>
                                                                                <input type="hidden" name="codigo" value="<%= timbradoLL.getId_tim()%>"> 
                                                                                <input type="submit" name="accion" target="_blank" class="btn btn-light action-button" value="Cambiar Inactivo">
                                                                                <input type="hidden" name="codigo2" value="<%= timbradoLL.getId_tim()%>">
