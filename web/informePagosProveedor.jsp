...
<html>
    ...
    <body>
        ...
        <%@ page import="model.InformePagos, java.util.ArrayList"  %>
        <%@ page import="controller.informePagos"  %>
        <%
            ArrayList<InformePagos> AA = null;
            AA = (ArrayList<InformePagos>) request.getAttribute("InformePagosL");
        %>  
        <%
            InformePagos infpag;
            infpag = (InformePagos) request.getAttribute("InformePagos");
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        <div class="page-header-title">
                                            <h3 class="m-b-10">Informe de Pagos Por Proveedor</h3>
                                        </div>                                        
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-xl-12">
                                        <div class="card">
                                            <div class="card-header">
                                                <hr>
                                                <div class="col-6">
                                                    <form name="form1" action="pdfPagoProveedor.jsp" target="_blank" method="post">                                                        
                                                        <input type="text" name="txtparametro" class="form-control" placeholder="Nombre del Proveedor"> 
                                                        <br>
                                                        <div>
                                                            <label>Seleccione tipo</label>&nbsp;&nbsp;&nbsp;&nbsp; 
                                                            <select class="form-control"  aria-label="Card Holder" name="txtpara">
                                                        ...
                                                        <br>
                                                        <input type="submit" name="btn1" target="_blank" class="btn btn-success action-button" value="Informe Pagos">                                                         
                                                    </form>
                                                </div>                                             
                                            </div>
                                            <hr>
                                                    ...
                                                    <nav class="navbar navbar-dark navbar-expand-md navigation-clean-search">
                                                        <ul class="nav navbar-nav">
                                                            <li class="dropdown">
                                                                ...
                                                                <input  type="hidden" name="txtprueba" class="form-control" aria-label="Card Holder" aria-describedby="basic-addon1"    id="descri" value="<%= infpag.getDescrip_pag()%>">
                                                            </li>                                                                        
