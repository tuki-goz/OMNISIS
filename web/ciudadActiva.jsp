<%-- 
    Document   : ciudadActiva
    Created on : 12/10/2021, 05:06:23 PM
...
<%
    Ciudad ciu;
    ciu = (Ciudad) request.getAttribute("Ciudad");
...
<html>
    ...
    <body>    <!-- Sacar ONLOAD para no ALert de mensaje guardado funcion -->
        ...
        <%@ page import="model.Ciudad, java.util.ArrayList"  %>
        <%@ page import="controller.ciudad"  %>
        <%            ArrayList<Ciudad> AA = null;
            AA = (ArrayList<Ciudad>) request.getAttribute("CiudadL");
        %>  
        <div class="loader-bg">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        <div class="page-header-title">
                                            <h3 class="m-b-10">Listado de Ciudades Activas</h3>
                                        </div>                                        
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-xl-12">
                                        <div class="card">
                                            <div class="card-header">
                                                <form action="ciudad" method="POST">
                                                    <input id="card-holder" type="text" name="buscartxt" class="form-control" placeholder="Buscar por descripción" aria-label="Card Holder" aria-describedby="basic-addon1" id="descri">
                                                    <br>
                                            ...
                                            <div>
                                                ...
                                                <div class="alert alert-warning alert-dismissible fade show text-center" role="alert" style="float: top;">
                                                    <strong>Genial!</strong> Ha sido registrada.
                                            ...
                                            <div>
                                                ...
                                                <div class="alert alert-secondary alert-dismissible fade show text-center" role="alert" style="float: top;">
                                                    <strong>Genial!</strong> Ha sido modificada.
                                                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                                        Ok
                                                    </button>
                                                </div>
                                            ...
                                            <div>
                                                ...
                                                %>
                                                <div class="alert alert-secondary alert-dismissible fade show text-center" role="alert" style="float: top;">
                                                    <strong>Genial!</strong> Ha sido activada.
                                                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                                        Ok
                                                    </button>
                                                </div>
                                                        ...
                                                        <div class="table-responsive">
                                                            <table class="table table-hover">
                                                                ...
                                                                <tr>  
                                                                    ...
                                                                    <td class="text-center"> 
                                                                        <%= ciudadLL.getDescripcion_ciu()%>
                                                                    </td>                                          
                                                                    <td class="text-center"> 
                                                                        <%= ciudadLL.getEstado_ciu()%>
                                                                    </td>                                 
                                                                    <td class="text-center"> 
                                                                        <%= ciudadLL.getDesc_dep()%>
                                                                    </td>                                 
                                                                    <td class="text-center">
                                                                        <div class="container-fluid margin">
                                                                            <form action="ciudad" method="POST">  <%-- ubicar el form  action de forma que todo lo que se quiere hacer este afectado, con sus inputs --%>
                                                                                <input type="hidden" name="codigo" value="<%= ciudadLL.getId_ciu()%>"> 
                                                                                <input type="submit" name="accion" target="_blank" class="btn btn-light action-button" value="Cambiar Inactivo">
                                                                                <input type="hidden" name="codigo2" value="<%= ciudadLL.getId_ciu()%>">
