...
<html>
    ...
    <body>
        <%@ page import="model.Proveedor, java.util.ArrayList"  %>
        <%@ page import="controller.cliente"  %>
        <%            ArrayList<Proveedor> AA = null;
            AA = (ArrayList<Proveedor>) request.getAttribute("ProveedorL");
        %>  
        <div class="loader-bg">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        <div class="page-header-title">
                                            <h3 class="m-b-10">Listado de Proveedores Activos</h3>
                                        </div>                                        
                                    </div>
                                </div>
                            </div>
                                                        ...
                                                        <div class="table-responsive">
                                                            <table class="table table-hover">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    %> 
                                                                    <%
                                                                        for (Proveedor proveedorLL : AA) {
                                                                    %>                                            
                                                                    <tr>  
                                                                        <td class="text-center"> 
                                                                            <%= proveedorLL.getId_prov()%>
                                                                        </td>
                                                                        <td class="text-center"> 
                                                                            <%= proveedorLL.getNom_prov()%>
                                                                        </td>                                          
                                                                        <td class="text-center"> 
                                                                            <%= proveedorLL.getRuc_prov()%>
                                                                        </td> 
                                                                        <td class="text-center"> 
                                                                            <%= proveedorLL.getTel_prov()%>
                                                                        </td>
                                                                        <td class="text-center"> 
                                                                            <%= proveedorLL.getDir_prov()%>
                                                                        </td>                                          
                                                                        <td class="text-center"> 
                                                                            <%= proveedorLL.getProc_prov()%>
                                                                        </td>                                          
                                                                        <td class="text-center"> 
                                                                            <%= proveedorLL.getCiu_prov()%>
                                                                        </td>
                                                                        <td class="text-center">                                                                           
                                                                            <div class="container-fluid margin">
                                                                                <form action="proveedor" method="POST">  <%-- ubicar el form  action de forma que todo lo que se quiere hacer este afectado, con sus inputs --%>
                                                                                    <input type="hidden" name="codigo" value="<%= proveedorLL.getId_prov()%>"> 
                                                                                    <input type="submit" name="accion" target="_blank" class="btn btn-dark action-button" value="Cambiar Inactivo">

                                                                                    <input type="hidden" name="codigo2" value="<%= proveedorLL.getId_prov()%>">
