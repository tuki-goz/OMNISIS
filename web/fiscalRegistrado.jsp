<%-- 
    Document   : fiscalRegistrado
    Created on : 31/10/2021, 11:53:47 AM
...
<%
    Fiscal fis;
    fis = (Fiscal) request.getAttribute("Fiscal");

%>
<!DOCTYPE html>
<html>
    <head>
        <title>Fiscales Registrados</title>
    ...
    <body>
        <%@ page import="model.Fiscal, java.util.ArrayList"  %>
        <%@ page import="controller.fiscal"  %>
        <%            ArrayList<Fiscal> AA = null;
            AA = (ArrayList<Fiscal>) request.getAttribute("FiscalL");
        %>  
        <div class="loader-bg">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        <div class="page-header-title">
                                            <h3 class="m-b-10">Listado de Fiscales Registrados</h3>
                                        </div>                                        
                                    </div>
                                </div>
                            </div>
                                                        ...
                                                        <div class="table-responsive">
                                                            <table class="table table-hover">
                                                                ...
                                                                <tr>  
                                                                    ...
                                                                    <td class="text-center"> 
                                                                        <%= fiscalLL.getDescrip_fis()%>
                                                                    </td>                                 
                                                                    <td class="text-center">
                                                                        <div class="container-fluid margin">
                                                                            <form action="fiscal" method="POST">  
                                                                                <input type="hidden" name="codigo2" value="<%= fiscalLL.getId_fis()%>">
