<%-- 
    Document   : bloqueousuario
    Created on : 21/08/2021, 07:46:21 PM
        ...
        <div class="container error-container">
            <div class="row  d-flex align-items-center justify-content-center">
                <div class="col-md-12 text-center">
                    <h1 class="big-text">Ndi!</h1>
                    <h2 class="small-text">USUARIO BLOQUEADO</h2>
                ...
                <div class="col-md-6  text-center">
                    ...
                    <a href="index.htm" class="button button-dark-blue iq-mt-15 text-center">ATRAS</a>
