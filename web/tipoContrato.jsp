...
<%
    TipoContrato tc;
    tc = (TipoContrato) request.getAttribute("TipoContrato");
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        <div class="page-header-title">
                                            <h1 class="m-b-10">Registrar nuevo tipo de contrato</h1>
                                        </div>
                                        <div class="page-header-title">
                                            <h5 class="m-b-10"></h5>
                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="form-group"> 
                                                                ...
                                                                <% if (tc.getDescrip() != null) {%>  <%--para sacar null--%>
                                                                <input id="card-holder" type="text" name="descriptxt" class="form-control" placeholder="Tipo del contrato" aria-label="Card Holder" aria-describedby="basic-addon1" pattern="[[A-Z][0-9]{0,}[a-z]{0,}{1,}" title="Tipo de Contrato" id="descri" value="<%= tc.getDescrip()%>">
                                                                <%  } else {%>
                                                                <input id="card-holder" type="text" name="descriptxt" class="form-control" placeholder="Tipo del contrato" aria-label="Card Holder" aria-describedby="basic-addon1" pattern="[[A-Z][0-9]{0,}[a-z]{0,}{1,}" title="Tipo de Contrato" id="descri" value="">
                                                                <% }%>                                    
                                                                <input id="card-holder" type="hidden" name="idtxt" class="form-control" aria-label="Card Holder" aria-describedby="basic-addon1" value="<%= tc.getId_tipo_contrato()%>">  
                                                                ...
                                                                <div>
                                                                    <nav class="navbar navbar-dark navbar-expand-md navigation-clean-search">
                                                                        <ul class="nav navbar-nav">
                                                                            ...
                                                                            <li class="dropdown">
                                                                                <% if (Variables.gua == 0) {%>
                                                                                <input onclick="myFunction()" type="submit" name="accion" target="_blank" class="btn btn-light action-button"  value="Registrar">
                                                                                <%}%>
                                                                            </li>                                                                          
                                                                            <li class="dropdown">
                                                                                <% if (Variables.mod == 0) {%>
