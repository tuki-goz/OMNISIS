<%-- 
    Document   : tipo_de_servicioActivo
    Created on : 13/10/2021, 09:28:00 AM
...
<%
    Tiposervicio ts;
    ts = (Tiposervicio) request.getAttribute("Tipo de Servicio");
...
<html>
    <head>
        <title>Tipo de Servicios Activos</title>
    ...
    <body>
        <%@ page import="model.Tiposervicio, java.util.ArrayList"  %>
        <%@ page import="controller.tipo_servicio"  %>
        <%            ArrayList<Tiposervicio> AA = null;
            AA = (ArrayList<Tiposervicio>) request.getAttribute("TipoServicioL");
        %>  
        <div class="loader-bg">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        <div class="page-header-title">
                                            <h3 class="m-b-10">Listado de Tipos de Servicios</h3>
                                        </div>                                        
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="card">
                                            ...
                                            <div>
                                                ...
                                                <div class="alert alert-warning alert-dismissible fade show text-center" role="alert" style="float: top;">
                                                    <strong>Genial!</strong> El registro ha sido guardado.
                                            ...
                                            <div>
                                                ...
                                                <div class="alert alert-secondary alert-dismissible fade show text-center" role="alert" style="float: top;">
                                                    <strong>Genial!</strong> El registro ha sido modificado.
                                                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                                        Ok
                                                    </button>
                                                </div>
                                                        ...
                                                        <div class="table-responsive">
                                                            <table class="table table-hover">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    %> 
                                                                    <%
                                                                        for (Tiposervicio tipo_servicioLL : AA) {
                                                                    %>                                            
                                                                    <tr>  
                                                                        <td class="text-center"> 
                                                                            <%= tipo_servicioLL.getId_tipo_servicio_tecnico()%>
                                                                        </td>
                                                                        <td class="text-center"> 
                                                                            <%= tipo_servicioLL.getDescripcion_tipo_servicio_tecnico()%>
                                                                        </td>                                          
                                                                        <td class="text-center"> 
                                                                            <%= tipo_servicioLL.getEstado_tipo_servicio()%>
                                                                        </td>                               
                                                                        <td class="text-center">
                                                                            <div class="container-fluid margin">
                                                                                <form action="tipo_servicio" method="POST">  <%-- ubicar el form  action de forma que todo lo que se quiere hacer este afectado, con sus inputs --%>
                                                                                    <input type="hidden" name="codigo" value="<%= tipo_servicioLL.getId_tipo_servicio_tecnico()%>"> 
                                                                                    <%--
                                                                                    <input type="submit" name="accion" target="_blank" class="btn btn-light action-button" value="Cambiar Inactivo">
                                                                                    --%>
                                                                                    <input type="hidden" name="codigo2" value="<%= tipo_servicioLL.getId_tipo_servicio_tecnico()%>">
