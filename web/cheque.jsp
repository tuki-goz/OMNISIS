<%-- 
    Document   : cheque
    Created on : 11/10/2021, 05:00:44 PM
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        <div class="page-header-title">
                                            <h1 class="m-b-10">Registrar cheque</h1>
                                        </div>
                                        <div class="page-header-title">
                                            <h5 class="m-b-10"></h5>
                                        </div>
                                                ...
                                                <form action="cobro" method="POST"> 
                                                    <div class="row">               
                                                        <div class="col-5 text-center">                                                                    
                                                            <label for="card-holder" >Banco:</label><span><label style="color: red">*</label></span> 
                                                            <select id="drop_ban" name="drop_ban" class="form-control" onChange="update()" >
                                                                <%
                                                                    Banco ban = new Banco();
                                                                    HashMap<String, String> drop_ban = ban.seleccionarBanco();
                                                                    for (String i : drop_ban.keySet()) {
                                                                        if (cob.getDesc_banco() != null) {
                                                                            if (drop_ban.get(i).toString().equals(cob.getDesc_banco().toString())) {
                                                                                out.println("<option value='" + i + "' selected>" + drop_ban.get(i) + "</option>");
                                                                            } else {
                                                                                out.println("<option value='" + i + "'>" + drop_ban.get(i) + "</option>");
                                                                            }
                                                                        } else {
                                                                            out.println("<option value='" + i + "'>" + drop_ban.get(i) + "</option>");
                                                                        }
                                                        ...
                                                        <div class="col-6 text-center">                                                                    
                                                            <label for="card-holder" >Monto:</label><span><label style="color: red">*</label></span> 
                                                            <input type="text" name="montochequetxt" class="form-control text-center" aria-label="Card Holder" aria-describedby="basic-addon1" value="<%= cob.getTotal_cobro()%>">
                                                        </div>
                                                        <div class="col-6 text-center">                                                                    
                                                            <label for="card-holder" >N° Cheque:</label><span><label style="color: red">*</label></span> 
                                                            <input type="text" name="nrochequetxt" class="form-control text-center" aria-label="Card Holder" aria-describedby="basic-addon1" value="">
                                                        </div>
                                                    </div>
                                                    <br>                
                                                    <br>   
