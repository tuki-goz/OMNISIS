<%-- 
    Document   : forma_cobroRealizados
    Created on : 13/10/2021, 12:33:41 AM
...
<html>
    <head>
        <title>Condición de pago - cobros</title>
    ...
    <body>
        <%@ page import="model.Condicion, java.util.ArrayList"  %>
        <%@ page import="controller.forma_cobro"  %>
        <%            ArrayList<Condicion> AA = null;
            AA = (ArrayList<Condicion>) request.getAttribute("CondicionL");
        %>  
        <div class="loader-bg">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        <div class="page-header-title">
                                            <h3 class="m-b-10">Listado de Condición de Pago - Cobro</h3>
                                        </div>                                        
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="card">
                                            ...
                                            <div>
                                                ...
                                                <div class="alert alert-warning alert-dismissible fade show text-center" role="alert" style="float: top;">
                                                    <strong>Genial!</strong> El regsitro ha sido guardado.
                                                        ...
                                                        <div class="table-responsive">
                                                            <table class="table table-hover">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    %> 
                                                                    <%
                                                                        for (Condicion condicionLL : AA) {
                                                                    %>                                            
                                                                    <tr>  
                                                                        <td class="text-center"> 
                                                                            <%= condicionLL.getId_condicion()%>
                                                                        </td>
                                                                        <td class="text-center"> 
                                                                            <%= condicionLL.getDescrip_condicion()%>
                                                                        </td>                             
                                                                        <td class="text-center">
                                                                            <div class="container-fluid margin">
                                                                                <form action="forma_cobro" method="POST">
                                                                                    <input type="hidden" name="codigo2" value="<%= condicionLL.getId_condicion()%>">
