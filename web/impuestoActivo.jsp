<%-- 
    Document   : impuestoActivo
    Created on : 13/10/2021, 11:35:44 AM
...
<html>
    ...
    <body>
        <%@ page import="model.Impuesto, java.util.ArrayList"  %>
        <%@ page import="controller.impuesto"  %>
        <%            ArrayList<Impuesto> AA = null;
            AA = (ArrayList<Impuesto>) request.getAttribute("ImpuestoL");
        %>  
        <div class="loader-bg">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        <div class="page-header-title">
                                            <h3 class="m-b-10">Listado de Impuestos Activos</h3>
                                        </div>                                        
                                    </div>
                                </div>
                            </div>
                                                        ...
                                                        <div class="table-responsive">
                                                            <table class="table table-hover">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    %> 
                                                                    <%
                                                                        for (Impuesto impuestoLL : AA) {
                                                                    %>                                            
                                                                    <tr>  
                                                                        <td class="text-center"> 
                                                                            <%= impuestoLL.getId_impuesto()%>
                                                                        </td>
                                                                        <td class="text-center"> 
                                                                            <%= impuestoLL.getDescripcion_impuesto()%>
                                                                        </td>                                          
                                                                        <td class="text-center"> 
                                                                            <%= impuestoLL.getCifra()%>
                                                                        </td>                                          
                                                                        <td class="text-center"> 
                                                                            <%= impuestoLL.getEstado_im()%>
                                                                        </td>                        
                                                                        <td class="text-center">
                                                                            <div class="container-fluid margin">
                                                                                <form action="impuesto" method="POST">  <%-- ubicar el form  action de forma que todo lo que se quiere hacer este afectado, con sus inputs --%>
                                                                                    <input type="hidden" name="codigo" value="<%= impuestoLL.getId_impuesto()%>"> 
                                                                                    
                                                                                    <input type="hidden" name="codigo2" value="<%= impuestoLL.getId_impuesto()%>">
