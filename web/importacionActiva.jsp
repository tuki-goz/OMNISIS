...
<%
    Importacion clie;
    clie = (Importacion) request.getAttribute("Importacion");
...
<html>
    ...
    <body>
        ...
        <%@ page import="model.Importacion, java.util.ArrayList"  %>
        <%@ page import="controller.cliente"  %>


        <%            ArrayList<Importacion> AA = null;
            AA = (ArrayList<Importacion>) request.getAttribute("ImportacionL");
        %>  
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        <div class="page-header-title">
                                            <h3 class="m-b-10">Listado de Importaciones Activos</h3>
                                        </div>                                        
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-xl-12">
                                        <div class="card">
                                            <div class="card-header">
                                                ...
                                                <form action="importacion" method="POST">
                                                    <input id="card-holder" type="text" name="buscartxt" class="form-control" placeholder="Buscar" aria-label="Card Holder" aria-describedby="basic-addon1"  title="Santísima Trinidad" id="descri">
                                                    <br>
                                                    ...
                                                    <input type="hidden" name="buscartxt" value="">                                                      
                                                    <input type="submit" name="accion" target="_blank" class="btn btn-danger action-button" value="Inactivo"> 
                                                    <%--
                                                            ...
                                                            <table class="table table-hover">
                                                                <thead>
                                                                    <tr>
                                                                        ...
                                                                        <th class="text-center">Precio Despacho</th>
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    %> 
                                                                    <%
                                                                        for (Importacion importacionLL : AA) {
                                                                    %>                                            
                                                                    <tr>  
                                                                        <td class="text-center"> 
                                                                            <%= importacionLL.getId_importacion()%>
                                                                        </td>
                                                                        <td class="text-center"> 
                                                                            <%= importacionLL.getLlamado()%>
                                                                        </td>                                          
                                                                        <td class="text-center"> 
                                                                            <%= importacionLL.getFecha_imp()%>
                                                                        </td> 
                                                                        <td class="text-center"> 
                                                                            <%= importacionLL.getMonto_fob()%>
                                                                        </td>
                                                                        <td class="text-center"> 
                                                                            <%= importacionLL.getMonto_flete()%>
                                                                        </td>                                          
                                                                        <td class="text-center"> 
                                                                            <%= importacionLL.getMonto_despacho()%>
                                                                        </td>
                                                                        <td class="text-center"> 
                                                                            <%= importacionLL.getMonto_total()%>
                                                                        </td>
                                                                        <td class="text-center"> 
                                                                            <%= importacionLL.getNom_prov()%>
                                                                        </td>
                                                                        <td class="text-center"> 
                                                                            <%= importacionLL.getDescrip_pais()%>
                                                                        </td>
                                                                        <td class="text-center"> 
                                                                            <%= importacionLL.getDescrip_clie()%>
                                                                        </td>
                                                                        <td class="text-center">
                                                                            <%-- no llama al index del array, guarda el id del usuario --%>

                                                                            <div class="container-fluid margin">
                                                                                <form action="importacion" method="POST">  <%-- ubicar el form  action de forma que todo lo que se quiere hacer este afectado, con sus inputs --%>
                                                                                    <input type="hidden" name="codigo" value="<%= importacionLL.getId_importacion()%>"> 
                                                                                    <input type="submit" name="accion" target="_blank" class="btn btn-light action-button" value="Cambiar Inactivo">

                                                                                    <input type="hidden" name="codigo2" value="<%= importacionLL.getId_importacion()%>">
                                                                                    <input type="submit" name="accion" target="_blank" class="btn btn-warning action-button" value="Editar">
                                                                                </form>
                                                                            </div> 
                                                                        </td> 
                                                                    </tr>
