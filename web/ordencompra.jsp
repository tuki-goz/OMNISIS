<%-- 
    ...
    Created on : 23/08/2021, 08:31:55 PM
    Author     : Alvaro
--%>
...
<html>
    <head>
        <title>Orden de Compra Realizadas</title>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        <div class="page-header-title">
                                            <h3 class="m-b-10">Listado de Orden de Compra Realizadas</h3>
                                        </div>                                        
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-xl-12">
                                        <div class="card">
                                            <div class="card-header">
                                                <form action="ordencompra" method="POST">
                                                    <input id="card-holder" type="text" name="buscartxt" class="form-control" placeholder="Buscar por n° de orden" aria-label="Card Holder" aria-describedby="basic-addon1" id="descri">
                                                    <br>                                             
                                                    <input type="submit" name="accion" target="_blank" class="btn btn-light action-button" value="Buscar">
                                                    <input type="submit" name="accion" target="_blank" class="btn btn-success action-button" value="Aprobados">        
                                                    <input type="submit" name="accion" target="_blank" class="btn btn-danger action-button" value="Cancelados">        
                                                </form>
                                            ...
                                            <div>
                                                <%            if (Variables.mensajeRegistrado == 2) {
                                                %>
                                                            ...
                                                            <table class="table table-hover">
                                                                <thead>
                                                                    <tr>
                                                                        ...
                                                                        <th class="text-center">N° Servicio Técnico:</th>
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    %> 
                                                                    <%
                                                                        for (Ordencompra orden_compraLL : AA) {
                                                                    %>                                            
                                                                    <tr>  
                                                                         <td class="text-center">
                                                                            <div class="container-fluid margin">
                                                                                <form action="ordencompra" method="POST">  <%-- ubicar el form  action de forma que todo lo que se quiere hacer este afectado, con sus inputs --%>
                                                                                    <input type="hidden" name="codigo" value="<%= orden_compraLL.getId_orden_com()%>"> 
                                                                                    <input type="hidden" name="totaltxt" value="<%= orden_compraLL.getTotal_pagar_orden_com()%>">                                                                                    
                                                                                    <input type="hidden" name="descriProvtxt" value=" <%= orden_compraLL.getNombre_prov()%>">                                                                                    
                                                                                    <input type="submit" name="accion" target="_blank" class="btn btn-success action-button" value="Aprobar">
                                                                                    <input type="hidden" name="codigo2" value="<%= orden_compraLL.getId_orden_com()%>">
                                                                                    <input type="submit" name="accion" target="_blank" class="btn btn-danger action-button" value="Cancelar">                                                                             
                                                                                    <input type="hidden" name="codigo4" value="<%= orden_compraLL.getId_orden_com()%>"> 
                                                                                    <button type="submit" name="accion" value="Ver" class="fas fa-search-plus btn btn-theme"></button>        
                                                                                </form>
                                                                            </div> 
                                                                        </td> 
                                                                        <td class="text-center"> 
                                                                            <%= orden_compraLL.getId_orden_com()%>
                                                                        </td>
                                                                        <td class="text-center"> 
                                                                            <%= Variables.nro_orden %>
                                                                        </td>                                          
                                                                        <td class="text-center"> 
                                                                            <%= orden_compraLL.getFecha_pedido_orden_com()%>
                                                                        </td>                                          
                                                                        <td class="text-center"> 
                                                                            <%= orden_compraLL.getEstado_orden_com()%>
                                                                        </td>                               
                                                                        <td class="text-center"> 
                                                                            <%= orden_compraLL.getNombre_prov()%>
                                                                        </td>                               
                                                                        <td class="text-center"> 
                                                                            <%= orden_compraLL.getNumero_st()%>
                                                                        </td>                                
                                                                        <td class="text-center"> 
                                                                            <%= orden_compraLL.getCodigo_cont()%>
                                                                        </td>                                
                                                                        <td class="text-center"> 
                                                                            <%= orden_compraLL.getTotal_pagar_orden_com()%>
                                                                        </td>                                      
                                                                    </tr>
                                                                    <% } %>
                                                                    <% } %>
