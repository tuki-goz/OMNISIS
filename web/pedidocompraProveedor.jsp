<%-- 
    Document   : pedidocompraProveedor
    Created on : 1/11/2021, 06:21:06 PM
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        <div class="page-header-title">
                                            <h3 class="m-b-10">Seleccionar proveedor</h3>
                                        </div>                                        
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-xl-12">
                                        <div class="card">
                                            <div class="card-header">
                                                <h5>Se muestran solo proveedores activos</h5>  
                                                <form action="ordencompra" method="POST">
                                                    ...
                                                    <button type="submit" name="accion" target="_blank" class="btn btn-light action-button" value="Buscar2">Seleccionar Proveedor</button>
                                                </form>                                               
                                            </div>
                                            <div class="card-body">
                                                <hr>
                                                                        ...
                                                                        <td class="text-center">
                                                                            <div class="container-fluid margin">
                                                                                <form action="ordencompra" method="POST">  <%-- ubicar el form  action de forma que todo lo que se quiere hacer este afectado, con sus inputs --%>                                               
                                                                                    ...
                                                                                    <input type="hidden" name="tp" value="<%= orden_com.getId_cond()%>">
                                                                                    <input type="submit" name="accion" target="_blank" class="btn btn-warning action-button" value="Agregar">
                                                                                </form>
                                                                            </div> 
                                                                        </td> 
                                                                    </tr>
