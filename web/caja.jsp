<%-- 
    Document   : caja
    Created on : 15/08/2021, 09:47:06 PM
    Author     : Francisca Gómez
--%>

<%@page import="model.Variables"%>
<%@page contentType="text/html" pageEncoding="UTF-8"%>
<%@page import="model.Caja"%>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        <div class="page-header-title">
                                            <h1 class="m-b-10">Registrar nueva caja</h1>
                                        </div>
                                        <div class="page-header-title">
                                            <h5 class="m-b-10"></h5>
                                        </div>
                                                ...
                                                <form action="caja" method="POST">
                                                    <div class="row">
                                                        <div class="col-3 text-center">
                                                            ...
                                                            <% if (caja.getDesc_caja()!= null) {%>  <%--para sacar null--%>
                                                            <input id="card-holder" type="text" name="descriptxt" class="form-control" placeholder="Descripcion de la caja" aria-label="Card Holder" aria-describedby="basic-addon1" pattern="[[A-Z][0-9]{0,}[a-z]{0,}{1,}" id="descri" value="<%=caja.getDesc_caja()%>">
                                                            <%  } else {%>
                                                            <input id="card-holder" type="text" name="descriptxt" class="form-control" placeholder="Descripcion de la caja" aria-label="Card Holder" aria-describedby="basic-addon1" pattern="[[A-Z][0-9]{0,}[a-z]{0,}{1,}" id="descri" value="">
                                                            <% }%>                                    
                                                            <input id="card-holder" type="hidden" name="idtxt" class="form-control" aria-label="Card Holder" aria-describedby="basic-addon1" value="<%= caja.getId_caja()%>">  
                                                        </div>
                                                        <div class="col-3 text-center">
                                                            <label for="card-holder" class="text-capitalize">Estado</label> 
                                                            <div class="custom-control custom-radio">
                                                                <% if (caja.getEstado_caja()== "activo") {%>
                                                                <div class="custom-control custom-radio">
                                                                ...
                                                                <% }%>
                                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                                <% if (caja.getEstado_caja()== "inactivo") {%>
                                                                <div class="custom-control custom-radio">
