...
<%
    Funcionario fun;
    fun = (Funcionario) request.getAttribute("Funcionario");
...
<html>
    <head>
        <title>Funcionarios Activos</title>
    ...
    <body>
        ...
        <%@ page import="model.Funcionario, java.util.ArrayList"  %>
        <%@ page import="controller.cliente"  %>


        <%            ArrayList<Funcionario> AA = null;
            AA = (ArrayList<Funcionario>) request.getAttribute("FuncionarioL");
        %>  
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        <div class="page-header-title">
                                            <h3 class="m-b-10">Listado de Funcionarios Activos</h3>
                                        </div>                                        
                                    </div>
                                </div>
                            </div>
                                                        ...
                                                        <div class="table-responsive">
                                                            <table class="table table-hover">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    %> 
                                                                    <%
                                                                        for (Funcionario funcionarioLL : AA) {
                                                                    %>                                            
                                                                    <tr>  
                                                                        <td class="text-center"> 
                                                                            <%= funcionarioLL.getId_fun()%>
                                                                        </td>
                                                                        <td class="text-center"> 
                                                                            <%= funcionarioLL.getNom_fun()%>
                                                                        </td>                                          
                                                                        <td class="text-center"> 
                                                                            <%= funcionarioLL.getApe_fun()%>
                                                                        </td> 
                                                                        <td class="text-center"> 
                                                                            <%= funcionarioLL.getCi_fun()%>
                                                                        </td>
                                                                        <td class="text-center"> 
                                                                            <%= funcionarioLL.getCargo_fun()%>
                                                                        </td>                                          
                                                                        <td class="text-center"> 
                                                                            <%= funcionarioLL.getEmail_fun()%>
                                                                        </td>
                                                                        <td class="text-center"> 
                                                                            <%= funcionarioLL.getTel_fun()%>
                                                                        </td>
                                                                        <td class="text-center"> 
                                                                            <%= funcionarioLL.getDir_fun()%>
                                                                        </td>
                                                                        <td class="text-center"> 
                                                                            <%= funcionarioLL.getDesc_barrio()%>
                                                                        </td>
                                                                        <td class="text-center">
                                                                            <%-- no llama al index del array, guarda el id del usuario --%>

                                                                            <div class="container-fluid margin">
                                                                                <form action="funcionario" method="POST">  <%-- ubicar el form  action de forma que todo lo que se quiere hacer este afectado, con sus inputs --%>
                                                                                    <input type="hidden" name="codigo" value="<%= funcionarioLL.getId_fun()%>"> 
                                                                                    <input type="submit" name="accion" target="_blank" class="btn btn-light action-button" value="Cambiar Inactivo">

                                                                                    <input type="hidden" name="codigo2" value="<%= funcionarioLL.getId_fun()%>">
