...
<img src="images/stop2.jpg">
        <div class="container error-container">
            <div class="row  d-flex align-items-center justify-content-center">
                <div class="col-md-12 text-center">
                    
                    <h1 class="big-text">Oops!</h1>
                    <h2 class="small-text">OCURRIO UN ERROR</h2>
                    <h2 class="small-text">YA EXISTE EL REGISTRO, NO SE PUEDE DUPLICAR</h2>
                </div>
                <div class="col-md-6  text-center">
                    ...
                    <a href="Principal.jsp" class="button button-dark-blue iq-mt-15 text-center">INTENTAR DE NUEVO</a>
