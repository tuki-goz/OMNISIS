                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        <div class="page-header-title">
                                            <h1 class="m-b-10">Registrar nuevo tipo de servicio</h1>
                                        </div>
                                        <div class="page-header-title">
                                            <h5 class="m-b-10"></h5>
                                        </div>
                                                ...
                                                <form action="tipo_servicio" method="POST">
                                                    <div class="row">
                                                        <div class="col-3 text-center">
                                                            ...
                                                            <% if (ts.getDescripcion_tipo_servicio_tecnico()!= null) {%>  <%--para sacar null--%>
                                                            <input id="card-holder" type="text" name="descriptxt" class="form-control" placeholder="Nombre del tipo de servicio" aria-label="Card Holder" aria-describedby="basic-addon1" pattern="[[A-Z]{0,}[a-z]{0,}\D{1,}" id="descri" value="<%=ts.getDescripcion_tipo_servicio_tecnico()%>">
                                                            <%  } else {%>
                                                            <input id="card-holder" type="text" name="descriptxt" class="form-control" placeholder="Nombre del tipo de servicio" aria-label="Card Holder" aria-describedby="basic-addon1" pattern="[[A-Z]{0,}[a-z]{0,}\D{1,}" id="descri" value="">
                                                            <% }%>                                    
                                                            <input id="card-holder" type="hidden" name="idtxt" class="form-control" aria-label="Card Holder" aria-describedby="basic-addon1" value="<%= ts.getId_tipo_servicio_tecnico()%>">  
                                                        </div>
                                                        <div class="col-3 text-center">
                                                            <label for="card-holder" class="text-capitalize">Estado</label> 
                                                            <div class="custom-control custom-radio">
                                                                <% if (ts.getEstado_tipo_servicio()== "activo") {%>
                                                                <div class="custom-control custom-radio">
                                                                ...
                                                                <% }%>
                                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                                <% if (ts.getEstado_tipo_servicio() == "inactivo") {%>
                                                                <div class="custom-control custom-radio">
