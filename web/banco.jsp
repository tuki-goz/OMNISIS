<%-- 
    Document   : banco
    Created on : 19/10/2021, 12:21:39 PM
...
<%
    Banco ban;
    ban = (Banco) request.getAttribute("Banco");
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        <div class="page-header-title">
                                            <h1 class="m-b-10">Registrar nuevo banco</h1>
                                        </div>
                                        <div class="page-header-title">
                                            <h5 class="m-b-10"></h5>
                                        </div>
                                                ...
                                                <form action="banco" method="POST">
                                                    <div class="row">
                                                        <div class="col-3 text-center">
                                                            <h6 class="text-capitalize">Descripción</h6>  
                                                            <% if (ban.getDesc_ban() != null) {%>  <%--para sacar null--%>
                                                            <input id="card-holder" type="text" name="descriptxt" class="form-control" placeholder="Nombre del banco" aria-label="Card Holder" aria-describedby="basic-addon1" pattern="[[A-Z]{0,}[a-z]{0,}\D{1,}" id="descri" value="<%=ban.getDesc_ban()%>">
                                                            <%  } else {%>
                                                            <input id="card-holder" type="text" name="descriptxt" class="form-control" placeholder="Nombre del banco" aria-label="Card Holder" aria-describedby="basic-addon1" pattern="[[A-Z]{0,}[a-z]{0,}\D{1,}" id="descri" value="">
                                                            <% }%>                                    
                                                            <input id="card-holder" type="hidden" name="idtxt" class="form-control" aria-label="Card Holder" aria-describedby="basic-addon1" value="<%= ban.getId_ban()%>">  
                                                        </div>
                                                        <div class="col-4 text-center">
                                                            <h6 class="text-capitalize">Dirección</h6>  
                                                            <% if (ban.getDir_ban() != null) {%>  <%--para sacar null--%>
                                                            <input id="card-holder" type="text" name="dirtxt" class="form-control" placeholder="Nombre de la dirección" aria-label="Card Holder" aria-describedby="basic-addon1" pattern="[[A-Z]{0,}[a-9]{0,}{1,}" id="descri" value="<%=ban.getDir_ban()%>">
                                                            <%  } else {%>
                                                            <input id="card-holder" type="text" name="dirtxt" class="form-control" placeholder="Nombre de la dirección" aria-label="Card Holder" aria-describedby="basic-addon1" pattern="[[A-Z]{0,}[a-9]{0,}{1,}" id="descri" value="">
                                                            <% }%>  
                                                        </div>
                                                        <div class="col-3 text-center">
                                                            <h6 class="text-capitalize">Email</h6>  
                                                            <% if (ban.getDir_ban() != null) {%>  <%--para sacar null--%>
                                                            <input id="card-holder" type="text" name="emailtxt" class="form-control" placeholder="Email" aria-label="Card Holder" aria-describedby="basic-addon1" pattern="^[^@]+@[^@]+\.[a-zA-Z]{2,}$" id="descri" value="<%=ban.getEmail_ban()%>">
                                                            <%  } else {%>
                                                            <input id="card-holder" type="text" name="emailtxt" class="form-control" placeholder="Email" aria-label="Card Holder" aria-describedby="basic-addon1" pattern="^[^@]+@[^@]+\.[a-zA-Z]{2,}$" id="descri" value="">
                                                            <% }%>  
                                                        </div>
                                                    </div>
                                                        <br>
                                                    <div class="row">
                                                        <div class="col-3 text-center">
                                                            <h6 class="text-capitalize">Telefono</h6>  
                                                            <% if (ban.getTel_ban() != null) {%>  <%--para sacar null--%>
                                                            <input id="card-holder" type="text" name="teltxt" class="form-control" placeholder="N° Telefono" aria-label="Card Holder" aria-describedby="basic-addon1" pattern="[0-9]\d{0,}" id="descri" value="<%=ban.getTel_ban()%>">
                                                            <%  } else {%>
                                                            <input id="card-holder" type="text" name="teltxt" class="form-control" placeholder="N° Telefono" aria-label="Card Holder" aria-describedby="basic-addon1" pattern="[0-9]\d{0,}" id="descri" value="">
                                                            <% }%> 
                                                        </div>
                                                        <div class="col-3 text-center">
                                                            <label for="card-holder" class="text-capitalize">Estado</label> 
                                                            <div class="custom-control custom-radio">
                                                                <% if (ban.getEstado_ban() == "activo") {%>
                                                                <div class="custom-control custom-radio">
