<%-- 
    Document   : informeVentasClienteFecha
    Created on : 8/12/2021, 06:26:13 PM
...
<html>
    ...
    <body>
        ...
        <%@ page import="model.InformeVentas, java.util.ArrayList"  %>
        <%@ page import="controller.informeVentas"  %>
        <%
            ArrayList<InformeVentas> AA = null;
            AA = (ArrayList<InformeVentas>) request.getAttribute("InformeVentasL");
        %>  
        <%
            InformeVentas infv;
            infv = (InformeVentas) request.getAttribute("InformeVentas");
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        <div class="page-header-title">
                                            <h3 class="m-b-10">Informe de Ventas con Pagos por Cliente y Fecha</h3>
                                        </div>                                        
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-xl-12">
                                        <div class="card">
                                            <div class="card-header">
                                                <div class="row">                                                        
                                                    <form name="form1" action="pdf_infventcliefech.jsp" target="_blank" method="post">                                                        
                                                        <label for="card-holder" class="text-capitalize b-title">Cliente</label> 
                                                        ...
                                                        <div class="form-group "> <%-- agregar espacio entre los labels &nbsp --%>
                                                            <div>
                                                                <label for="card-holder" class="text-capitalize">Fecha Desde</label> 
                                                        ...
                                                        <div class="form-group "> <%-- agregar espacio entre los labels &nbsp --%>
                                                            <div>
                                                                <label for="card-holder" class="text-capitalize">Fecha Hasta</label> 
                                                                <input type="date" name="fechafintxt" id="fechaActual2" class="form-control"  aria-label="Card Holder" aria-describedby="basic-addon1"> 
                                                            </div>                                                                                                                   
                                                        </div> 
                                                       
                                                        <br>
                                                        <input type="submit" name="btn1" target="_blank" class="btn btn-success action-button" value="Informe por Cliente y Fecha"> 
                                                    ...
                                                    <nav class="navbar navbar-dark navbar-expand-md navigation-clean-search">
                                                        <ul class="nav navbar-nav">
                                                            <li class="dropdown">
                                                                ...
                                                                <input  type="hidden" name="txtprueba" class="form-control" aria-label="Card Holder" aria-describedby="basic-addon1"    id="descri" value="<%= infv.getNombre_razon_venta()%>">
                                                            </li>                                                                        
