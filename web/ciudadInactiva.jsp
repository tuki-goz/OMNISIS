<%-- 
    Document   : ciudadInactiva
    Created on : 18/10/2021, 06:47:11 PM
...
<html>
    <head>
        <title>Ciudades Inactivas</title>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        <div class="page-header-title">
                                            <h3 class="m-b-10">Listado de Ciudades Inactivas</h3>
                                        </div>                                        
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="card">
                                            ...
                                            <div>
                                                ...
                                                <div class="alert alert-secondary alert-dismissible fade show text-center" role="alert" style="float: top;">
                                                    <strong>Genial!</strong> Ha sido inactivada.
