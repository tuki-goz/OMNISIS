<%-- 
    Document   : informeVentasFecha
    Created on : 8/12/2021, 08:53:43 PM
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        <div class="page-header-title">
                                            <h3 class="m-b-10">Informe de Ventas con Pagos por Fecha</h3>
                                        </div>                                        
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-xl-12">
                                        <div class="card">
                                            <div class="card-header">
                                                <div class="row">                                                        
                                                    <form name="form1" action="pdf_infventfecha.jsp" target="_blank" method="post"> 
                                                        ...
                                                        <br>
                                                        <input type="submit" name="btn1" target="_blank" class="btn btn-success action-button" value="Informe de Pendientes por Fecha">
                                                    </form>
                                                </div>
                                            </div>
                                            <form action="informeVentas" method="POST"> 
