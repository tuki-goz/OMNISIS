<%-- 
    Document   : pedidocompraProducto
    Created on : 4/11/2021, 06:47:19 PM
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        <div class="page-header-title">
                                            <h3 class="m-b-10">Listado de Producto Activos</h3>
                                        </div>                                        
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-xl-12">
                                        <div class="card">
                                            <div class="card-header">
                                                <h5>Se muestran solo productos activos</h5>  
                                                <form action="producto" method="POST">
                                                    <input id="card-holder" type="text" name="buscartxt" class="form-control" placeholder="Buscar" aria-label="Card Holder" aria-describedby="basic-addon1" id="descri">
                                                    <input type="submit" name="accion" target="_blank" class="btn btn-light action-button" value="Buscar Producto"> 
                                                </form>
                                            </div>
                                            <div class="card-body">
                                                <hr>
                                                            ...
                                                            <table class="table table-hover">
                                                                <thead>
                                                                    <tr>
                                                                        ...
                                                                        <th class="text-center">Cantidad a Comprar&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Opción&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
                                                                    </tr>
                                                                </thead>
                                                                <tbody>
                                                                    ...
                                                                    <tr>  
                                                                        <td class="text-center"> 
                                                                            <%= productoLL.getId_producto()%>
                                                                        </td>
                                                                        <td class="text-center"> 
                                                                            <%= productoLL.getDescripcion_producto()%>
                                                                        </td>
                                                                        <td class="text-center"> 
                                                                            <%= productoLL.getCifra_imp()%>
                                                                        </td>                                                                       
                                                                        <td class="text-center"> 
                                                                            <%= productoLL.getPrecio_u_producto()%>
                                                                        </td>  
                                                                        <td class="text-center"> 
                                                                            <%= productoLL.getCantidad()%> 
                                                                        </td>
                                                                        <td class="text-center">
                                                                            <div class="container-fluid margin">
                                                                                <form action="ordencompra" method="POST">  
                                                                                    <input type="number" name="cantidad" value="" min="1" max="<%= productoLL.getCantidad()%>">  
                                                                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;                                                                                 
                                                                                    &nbsp;&nbsp;&nbsp;&nbsp;      
                                                                                    <input type="hidden" name="descri" value="<%= productoLL.getDescripcion_producto()%>">
                                                                                    <input type="hidden" name="cifra" value="<%= productoLL.getCifra_imp()%>">
                                                                                    <input type="hidden" name="precio" value="<%= productoLL.getPrecio_u_producto()%>">
                                                                                    <input type="hidden" name="codigo2" value="<%= productoLL.getId_producto()%>">
                                                                                    <input type="hidden" name="cantxt" value="<%= productoLL.getCantidad()%>"> 
                                                                                    <button type="submit" name="accion" class="btn btn-warning action-button" value="Seleccionar2">Seleccionar</button>                                                              
                                                                                </form>
                                                                            </div> 
                                                                        </td> 
                                                                    </tr>
                                                    ...
                                                    <div>
                                                        <nav class="navbar navbar-dark navbar-expand-md navigation-clean-search">
                                                            <ul class="nav navbar-nav">
                                                                <li class="dropdown">
                                                                    <button type="submit" name="accion" target="_blank" class="btn btn-light action-button" value="Atras2">Atrás</button>
                                                                </li>                                                                        
