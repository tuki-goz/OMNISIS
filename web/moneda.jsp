...
<%
    Moneda mon;
    mon = (Moneda) request.getAttribute("Moneda");
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        <div class="page-header-title">
                                            <h1 class="m-b-10">Registrar nueva moneda</h1>
                                        </div>
                                        <div class="page-header-title">
                                            <h5 class="m-b-10"></h5>
                                        </div>
                                                ...
                                                <form action="moneda" method="POST">
                                                    <div class="row">
                                                        <div class="col-3 text-center">
                                                            ...
                                                            <% if (mon.getDesc_moneda() != null) {%>  
                                                            <input id="card-holder" type="text" name="descriptxt" class="form-control" placeholder="Nombre de la moneda" aria-label="Card Holder" aria-describedby="basic-addon1" pattern="[[A-Z]{0,}[a-z]{0,}\D{1,}" id="descri" value="<%=mon.getDesc_moneda()%>">
                                                            <%  } else {%>
                                                            <input id="card-holder" type="text" name="descriptxt" class="form-control" placeholder="Nombre de la moneda" aria-label="Card Holder" aria-describedby="basic-addon1" pattern="[[A-Z]{0,}[a-z]{0,}\D{1,}" id="descri" value="">
                                                            <% }%>                                    
                                                            <input id="card-holder" type="hidden" name="idtxt" class="form-control" aria-label="Card Holder" aria-describedby="basic-addon1" value="<%= mon.getId_moneda()%>">  
                                                        </div>
                                                        <div class="col-3 text-center">
                                                            <h6 class="text-capitalize">Cotización de la Compra Actual</h6>  
                                                            <% if (mon.getCoti_compra_actual_moneda() != 0) {%>  
                                                            <input id="card-holder" type="text" name="cotiCompratxt" class="form-control" placeholder="Cotizacion de moneda" aria-label="Card Holder" aria-describedby="basic-addon1" pattern="[[0-9]{0,}]" id="descri" value="<%=mon.getCoti_compra_actual_moneda()%>">
                                                            <%  } else {%>
                                                            <input id="card-holder" type="text" name="cotiCompratxt" class="form-control" placeholder="Cotizacion de moneda" aria-label="Card Holder" aria-describedby="basic-addon1" pattern="[[0-9]{0,}]" id="descri" value="">
                                                            <% }%>     
                                                        </div>
                                                        <div class="col-3 text-center">
                                                            <h6 class="text-capitalize">Cotización de la Venta Actual</h6>  
                                                            <% if (mon.getCoti_venta_actual_moneda() != 0) {%>  
                                                            <input id="card-holder" type="text" name="cotiVentatxt" class="form-control" placeholder="Cotizacion de moneda" aria-label="Card Holder" aria-describedby="basic-addon1" pattern="[[0-9]{0,}]" id="descri" value="<%=mon.getCoti_venta_actual_moneda()%>">
                                                            <%  } else {%>
                                                            <input id="card-holder" type="text" name="cotiVentatxt" class="form-control" placeholder="Cotizacion de moneda" aria-label="Card Holder" aria-describedby="basic-addon1" pattern="[[0-9]{0,}]" id="descri" value="">
                                                            <% }%>     
                                                        </div>
                                                        <div class="col-3 text-center">
                                                            <h6 class="text-capitalize">Fecha</h6>  
                                                            <% if (mon.getFecha_mon() != null) {%>  <%--para sacar null--%>
                                                            <input type="date" name="fecha" class="form-control" value="<%= mon.getFecha_mon()%>">
                                                            <%  } else {%>
                                                    ...
                                                    <div class="row">                                                        
                                                        <div class="col-3 text-center">
                                                            ...
                                                            <div class="custom-control custom-radio">
                                                                <% if (mon.getEstado_moneda() == "activo") {%>
                                                                <div class="custom-control custom-radio">
                                                                ...
                                                                <% }%>
                                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                                <% if (mon.getEstado_moneda() == "inactivo") {%>
                                                                <div class="custom-control custom-radio">
