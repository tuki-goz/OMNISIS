...
<%
    Perfil p;
    p = (Perfil) request.getAttribute("Perfil");
...
<html>
    ...
    <body>
        <%@ page import="model.Perfil, java.util.ArrayList"  %>
        <%@ page import="controller.perfil"  %>
        <%            ArrayList<Perfil> AA = null;
            AA = (ArrayList<Perfil>) request.getAttribute("PerfilL");
        %>  
        <div class="loader-bg">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        <div class="page-header-title">
                                            <h3 class="m-b-10">Listado de Perfiles Activos</h3>
                                        </div>                                        
                                    </div>
                                </div>
                            </div>
                                                    ...
                                                    <div class="card-block table-border-style">
                                                        <div class="table-responsive">
                                                            <table class="table table-hover">
                                                                ...
                                                                %> 
                                                                <%
                                                                    for (Perfil perfilLL : AA) {
                                                                %>                                            
                                                                <tr>  
                                                                    <td class="text-center"> 
                                                                        <%= perfilLL.getId_perfil()%>
                                                                    </td>
                                                                    <td class="text-center"> 
                                                                        <%= perfilLL.getDescrip_perfil()%>
                                                                    </td>                                          
                                                                                                    
                                                                    <td class="text-center">
                                                                        <div class="container-fluid margin">
                                                                            <form action="perfil" method="POST">  <%-- ubicar el form  action de forma que todo lo que se quiere hacer este afectado, con sus inputs --%>
                                                                                <input type="hidden" name="codigo" value="<%= perfilLL.getId_perfil()%>"> 
                                                                                
                                                                                <input type="hidden" name="codigo2" value="<%= perfilLL.getId_perfil()%>">
