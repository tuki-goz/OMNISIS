                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <%  } else {%>
                                                                <input   id="card-holder" type="text" name="codigocontratotxt" class="form-control" placeholder="Código del contrato" aria-label="Card Holder" aria-describedby="basic-addon1"  value="">
                                                                <% }%> 
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <%  } else {%>
                                                                <input   id="card-holder" type="text" name="valideztxt" class="form-control" placeholder="Validéz" aria-label="Card Holder" aria-describedby="basic-addon1"  value="">
                                                                <% }%> 
                                                            </div>  
