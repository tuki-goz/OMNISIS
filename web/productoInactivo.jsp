                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        <div class="page-header-title">
                                            <h3 class="m-b-10">Listado de Producto Inactivos</h3>
                                        </div>                                        
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-xl-12">
                                        <div class="card">
                                            <div class="card-header">
                                                <h5>Se muestran solo productos inactivos</h5>  
                                                <li>
                                                    <form action="producto" method="POST">
                                                            ...
                                                            <ul class="nav navbar-nav">
                                                                <form action="producto" method="POST">
                                                                    <li class="dropdown">
                                                                        ...
                                                                        <input type="submit" name="accion" target="_blank" class="btn btn-light action-button" value="Activo"></span>
