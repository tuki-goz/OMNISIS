                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        <div class="page-header-title">
                                            <h1 class="m-b-10">Registrar nueva ciudad</h1>
                                        </div>
                                        <div class="page-header-title">
                                            <h5 class="m-b-10"></h5>
                                        </div>
                                                ...
                                                <form action="ciudad" method="POST">
                                                    <div class="row">
                                                        <div class="col-3 text-center">
                                                            ...
                                                            <% if (ciu.getDescripcion_ciu()!= null) {%>  <%--para sacar null--%>
                                                            <input id="card-holder" type="text" name="descriptxt" class="form-control" placeholder="Nombre de la ciudad" aria-label="Card Holder" aria-describedby="basic-addon1" pattern="[[A-Z]{0,}[a-z]{0,}\D{1,}" id="descri" value="<%=ciu.getDescripcion_ciu()%>">
                                                            <%  } else {%>
                                                            <input id="card-holder" type="text" name="descriptxt" class="form-control" placeholder="Nombre de la ciudad" aria-label="Card Holder" aria-describedby="basic-addon1" pattern="[[A-Z]{0,}[a-z]{0,}\D{1,}" id="descri" value="">
                                                            <% }%>                                    
                                                            <input id="card-holder" type="hidden" name="idtxt" class="form-control" aria-label="Card Holder" aria-describedby="basic-addon1" value="<%= ciu.getId_ciu()%>">  
                                                        </div>
                                                        <div class="col-3 text-center">
                                                            <label for="card-holder" class="text-capitalize">Estado</label> 
                                                            <div class="custom-control custom-radio">
                                                                <% if (ciu.getEstado_ciu()== "activo") {%>
                                                                <div class="custom-control custom-radio">
                                                        ...
                                                        <div class="col-3 text-center">
                                                            ...
                                                            <select id="drop_dep" name="drop_dep" class="form-control" onChange="update()" >
                                                                <%
                                                                    Departamento dep = new Departamento();
                                                                    HashMap<String, String> drop = dep.seleccionarDepartamento();
                                                                    for (String i : drop.keySet()) {
                                                                        if (ciu.getDesc_dep()!= null) {
                                                                            if (drop.get(i).toString().equals(ciu.getDesc_dep().toString())) {
