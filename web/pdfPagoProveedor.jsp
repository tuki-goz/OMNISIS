...
<html>
    ...
    <body>
        ...
        <%
        File reportfile = new File (application.getRealPath("informePagoProveedor.jasper"));
        
        Map<String,Object> parameter = new HashMap<String,Object>();
        
       String valor1 =(request.getParameter("txtparametro"));
       String valor2 =(request.getParameter("txtpara"));
       String valor3 =(request.getParameter("txtusuario"));
        parameter.put("proveedor",new String(valor1));
        parameter.put("tipo",new String(valor2));
