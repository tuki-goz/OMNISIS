<%-- 
    Document   : informeCobrosClienteFecha
    Created on : 12/12/2021, 04:53:50 PM
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        <div class="page-header-title">
                                            <h3 class="m-b-10">Informe de Cobros por Cliente y Fecha</h3>
                                        </div>                                        
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-xl-12">
                                        <div class="card">
                                            <div class="card-header">
                                                <hr>
                                                <form name="form1" action="pdfCobroClienteFecha.jsp" target="_blank" method="post"> 
                                                    <div class="col-md-6">
                                                        ...
                                                        <br>
                                                        <input type="submit" name="btn1" target="_blank" class="btn btn-success action-button" value="Informe de Cobros">
                                                    </div>
                                                </form>
