<%-- 
    Document   : paisInactivo
    Created on : 05/09/2021, 03:52:05 PM
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        <div class="page-header-title">
                                            <h3 class="m-b-10">Listado de Usuarios Inactivos</h3>
                                        </div>                                        
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-xl-12">
                                        <div class="card">                                          
                                            <div class="card-header">
                                                <h5>Se muestran solo usuarios inactivos</h5>  
                                                <form action="usuario" method="POST">
                                                                        ...
                                                                        <td class="text-center">
                                                                            ...
                                                                            <div class="container-fluid margin">
                                                                                <form action="usuario" method="POST">  <%-- ubicar el form  action de forma que todo lo que se quiere hacer este afectado, con sus inputs --%>
                                                                                    ...
                                                                                    <input type="hidden" name="nombretxt" value="<%= usuarioLL.getNom_usu()%>"> 
                                                                                    <input type="submit" name="accion" target="_blank" class="btn btn-light action-button" value="Restablecer">
