<%-- 
    Document   : barrioActivo
    Created on : 12/10/2021, 11:31:37 PM
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        <div class="page-header-title">
                                            <h3 class="m-b-10">Listado de Barrios Activos</h3>
                                        </div>                                        
                                    </div>
                                </div>
                            </div>
                                                                        ...
                                                                        <td class="text-center">
                                                                            <div class="container-fluid margin">
                                                                                <form action="barrio" method="POST">  <%-- ubicar el form  action de forma que todo lo que se quiere hacer este afectado, con sus inputs --%>
                                                                                    ...
                                                                                    <input type="hidden" name="codigo2" value="<%= barrioLL.getId_barrio()%>">
