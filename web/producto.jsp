                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        <div class="page-header-title">
                                            <h1 class="m-b-10">Registrar nuevo producto</h1>
                                        </div>
                                        <%--
                                        <div class="page-header-title">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <hr>
                                                <form action="producto" method="POST" id="newForm">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <%----------------------------------------------------------------- --%>
                                                            <div class="form-group">                                                                 
                                                                <h5 class="mt-5">Descripción</h5>
                                                                <% if (pr.getDescripcion_producto() != null) {%> 
                                                                &nbsp;&nbsp;&nbsp;<input id="card-holder" type="text" name="descriptxt" class="form-control" aria-label="Card Holder"  aria-describedby="basic-addon1"  title="Scanner" id="descri" value="<%= pr.getDescripcion_producto()%>">
                                                                <%  } else {%>
                                                                &nbsp;&nbsp;&nbsp;<input id="card-holder" type="text" name="descriptxt" class="form-control" aria-label="Card Holder"  aria-describedby="basic-addon1"  title="Scanner" id="descri" value="">
                                                                <% }%>
                                                                <%--
                                                                <h5 class="mt-5">Cantidad</h5>
                                                                 
                                                                &nbsp;&nbsp;&nbsp;<input id="card-holder" type="text" name="canttxt" class="form-control" aria-label="Card Holder"  aria-describedby="basic-addon1"  title="Scanner" id="descri" value="<%= pr.getCantidad()%>">
                                                                --%>
                                                           
                                                                <input id="card-holder" type="hidden" name="idtxt" class="form-control" aria-label="Card Holder" aria-describedby="basic-addon1" value="<%= pr.getId_producto()%>">                                                               

                                                                <h5 class="mt-5">Impuesto</h5>
                                                                <select id="drop_imp" name="drop_imp" class="form-control" onChange="update()" >
                                                                    <%
                                                                        Impuesto imp = new Impuesto();
                                                                        HashMap<String, String> drop = imp.seleccionarImpuesto();
                                                                        for (String i : drop.keySet()) {
                                                                            if (pr.getDescripcion_impuesto() != null) {
                                                                                if (drop.get(i).toString().equals(pr.getDescripcion_impuesto().toString())) {
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group "> 
                                                                 <h5 class="mt-5">Precio Unitario</h5>
                                                                 
                                                                &nbsp;&nbsp;&nbsp;<input id="card-holder" type="text" name="precioutxt" class="form-control" aria-label="Card Holder"  aria-describedby="basic-addon1" title="Scanner" id="descri" value="<%= pr.getPrecio_u_producto()%>">
                                                             
                                                                <h5 class="mt-5">Estado</h5>
                                                                <hr>   <%--   INSERTAR RAYA EN EL FORM --%>
