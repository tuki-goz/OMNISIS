<%-- 
    Document   : departamentoActivo
    Created on : 12/10/2021, 01:57:04 PM
...
<%
    Departamento dep;
    dep = (Departamento) request.getAttribute("Departamento");
...
<html>
    <head>
        <title>Departamentos Activos</title>
    ...
    <body>    <!-- Sacar ONLOAD para no ALert de mensaje guardado funcion -->
        ...
        <%@ page import="model.Departamento, java.util.ArrayList"  %>
        <%@ page import="controller.departamento"  %>
        <%            ArrayList<Departamento> AA = null;
            AA = (ArrayList<Departamento>) request.getAttribute("DepartamentoL");
        %>  
        <div class="loader-bg">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        <div class="page-header-title">
                                            <h3 class="m-b-10">Listado de Departamentos Activos</h3>
                                        </div>                                        
                                    </div>
                                </div>
                            </div>
                                                            ...
                                                            <div class="card-block table-border-style">
                                                                <div class="table-responsive">
                                                                    <table class="table table-hover">
                                                                        ...
                                                                        %> 
                                                                        <%
                                                                            for (Departamento departamentoLL : AA) {
                                                                        %>                                            
                                                                        <tr>  
                                                                            <td class="text-center"> 
                                                                                <%= departamentoLL.getId_dep()%>
                                                                            </td>
                                                                            <td class="text-center"> 
                                                                                <%= departamentoLL.getDescripcion_dep()%>
                                                                            </td>                                          
                                                                            <td class="text-center"> 
                                                                                <%= departamentoLL.getEstado_dep()%>
                                                                            </td>                                 
                                                                            <td class="text-center"> 
                                                                                <%= departamentoLL.getDescripcion_pais()%>
                                                                            </td>                                 
                                                                            <td class="text-center">
                                                                                <div class="container-fluid margin">
                                                                                    <form action="departamento" method="POST">  <%-- ubicar el form  action de forma que todo lo que se quiere hacer este afectado, con sus inputs --%>
                                                                                        <input type="hidden" name="codigo" value="<%= departamentoLL.getId_dep()%>"> 
                                                                                        <input type="submit" name="accion" target="_blank" class="btn btn-light action-button" value="Cambiar Inactivo">
                                                                                        <input type="hidden" name="codigo2" value="<%= departamentoLL.getId_dep()%>">
