<%-- 
    Document   : pedidocompraListado
    Created on : 4/11/2021, 06:25:05 PM
...
<html>
    <head>
        <title>Pedido de Compras Realizadas</title>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        <div class="page-header-title">
                                            <h3 class="m-b-10">Listado de Pedido de Compra Realizadas</h3>
                                        </div>                                        
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="card">
                                            <div class="card-header">
                                                <form action="ordencompra" method="POST">
                                                    ...
                                                    <input type="hidden" name="buscartxt" value=""> 
                                                    <input type="hidden" name="nroOrdentxt" value="<%= Variables.nro_orden%>"> 
                                                            ...
                                                            <table class="table table-hover">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>  
                                                                        <td class="text-center">
                                                                            <div class="container-fluid margin">
                                                                                <form action="ordencompra" method="POST">  <%-- ubicar el form  action de forma que todo lo que se quiere hacer este afectado, con sus inputs --%>
                                                                                    <input type="hidden" name="codigo3" value="<%= orden_compraLL.getId_orden_com()%>"> 
                                                                        ...
                                                                        <td class="text-center"> 
                                                                            <%= orden_compraLL.getNro_orden_com() %>
                                                                        </td>                                          
                                                                        <td class="text-center"> 
