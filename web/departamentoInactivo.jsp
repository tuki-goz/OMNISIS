<%-- 
    Document   : departamentoInactivo
    Created on : 18/10/2021, 05:57:23 PM
...
<html>
    <head>
        <title>Departamentos Inactivos</title>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        <div class="page-header-title">
                                            <h3 class="m-b-10">Listado de Departamentos Inactivos</h3>
                                        </div>                                        
                                    </div>
                                </div>
                            </div>
