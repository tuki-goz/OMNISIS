                                    ...
                                    <div class="col-xl-12">
                                        <div class="card">
                                            <div class="card-header">
                                                    ...
                                                    <form action="contrato" method="POST">
                                                        <input id="card-holder" type="text" name="buscartxt" class="form-control" placeholder="Ej: Santísima Trinidad" aria-label="Card Holder" aria-describedby="basic-addon1"  title="Santísima Trinidad" id="descri">
                                                        <br>
                                                            ...
                                                            <table class="table table-hover">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>   
                                                                        ...
                                                                        <td class="text-center"> 
                                                                            <%= contratoLL.getFiscal_contrato()%>
                                                                        </td>  
                                                                        <td class="text-center"> 
                                                                            <%= contratoLL.getCodigo_contrato()%>
                                                                        </td>
                                                                        <td class="text-center"> 
                                                                            <%= contratoLL.getValidez_contrato()%>
                                                                        </td> 
                                                                        <td class="text-center"> 
                                                                            <%= contratoLL.getFecha_inicio()%>
                                                                        </td>     
                                                                        <td class="text-center"> 
                                                                            <%= contratoLL.getFecha_fin()%>
                                                                        </td>  
                                                                        <td class="text-center"> 
                                                                            <%= contratoLL.getTipo_contrato()%>
                                                                        </td>
                                                                        <td class="text-center"> 
                                                                            <%= contratoLL.getEstado_contrato()%>
                                                                        </td>  
                                                                        <td class="text-center"> 
                                                                            <%= contratoLL.getDescripcion_cliente()%>
                                                                        </td>
                                                                        <td class="text-center">
                                                                            ...
                                                                            <div class="container-fluid margin">
                                                                                <form action="contrato" method="POST">
                                                                                    ...
                                                                                    <input type="hidden" name="codigo2" value="<%= contratoLL.getId_contrato()%>">                                                                                    
