<%-- 
    Document   : fiscal
    Created on : 31/10/2021, 11:53:58 AM
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        <div class="page-header-title">
                                            <h1 class="m-b-10">Registrar nuevo fiscal</h1>
                                        </div>
                                        <div class="page-header-title">
                                            <h5 class="m-b-10"></h5>
                                        </div>
                                                ...
                                                <form action="fiscal" method="POST">
                                                    <div class="row">
                                                        <div class="col-3 text-center">
                                                            ...
                                                            <% if (fis.getDescrip_fis() != null) {%>  <%--para sacar null--%>
                                                            <input id="card-holder" type="text" name="descriptxt" class="form-control" placeholder="Descripcion del fiscal" aria-label="Card Holder" aria-describedby="basic-addon1" pattern="[[A-Z][0-9]{0,}[a-z]{0,}{1,}" id="descri" value="<%=fis.getDescrip_fis()%>">
                                                            <%  } else {%>
                                                            <input id="card-holder" type="text" name="descriptxt" class="form-control" placeholder="Descripcion del fiscal" aria-label="Card Holder" aria-describedby="basic-addon1" pattern="[[A-Z][0-9]{0,}[a-z]{0,}{1,}" id="descri" value="">
                                                            <% }%>                                    
                                                            <input id="card-holder" type="hidden" name="idtxt" class="form-control" aria-label="Card Holder" aria-describedby="basic-addon1" value="<%= fis.getId_fis()%>">  
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
