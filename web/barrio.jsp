                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        <div class="page-header-title">
                                            <h1 class="m-b-10">Registrar nuevo barrio</h1>
                                        </div>
                                        <div class="page-header-title">
                                            <h5 class="m-b-10"></h5>
                                        </div>
                                                ...
                                                <form action="barrio" method="POST">
                                                    <div class="row">
                                                        <div class="col-3 text-center">
                                                            ...
                                                            <% if (bar.getDescripcion_barrio()!= null) {%>  <%--para sacar null--%>
                                                            <input id="card-holder" type="text" name="descriptxt" class="form-control" placeholder="Nombre del barrio" aria-label="Card Holder" aria-describedby="basic-addon1" pattern="[[A-Z]{0,}[a-z]{0,}\D{1,}" id="descri" value="<%=bar.getDescripcion_barrio()%>">
                                                            <%  } else {%>
                                                            <input id="card-holder" type="text" name="descriptxt" class="form-control" placeholder="Nombre del barrio" aria-label="Card Holder" aria-describedby="basic-addon1" pattern="[[A-Z]{0,}[a-z]{0,}\D{1,}" id="descri" value="">
                                                            <% }%>                                    
                                                            <input id="card-holder" type="hidden" name="idtxt" class="form-control" aria-label="Card Holder" aria-describedby="basic-addon1" value="<%= bar.getId_barrio()%>">  
                                                        </div>
                                                        <div class="col-3 text-center">
                                                            <label for="card-holder" class="text-capitalize">Estado</label> 
                                                            <div class="custom-control custom-radio">
                                                                <% if (bar.getEstado_bar()== "activo") {%>
                                                                <div class="custom-control custom-radio">
                                                        ...
                                                        <div class="col-3 text-center">
                                                            ...
                                                            <select id="drop_ciu" name="drop_ciu" class="form-control" onChange="update()" >
                                                                <%
                                                                    ...
                                                                    HashMap<String, String> drop = ciu.seleccionarCiudad();
                                                                    for (String i : drop.keySet()) {
                                                                        if (bar.getDescripcion_ciudad()!= null) {
                                                                            if (drop.get(i).toString().equals(bar.getDescripcion_ciudad().toString())) {
