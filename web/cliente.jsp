                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        <div class="page-header-title">
                                            <h1 class="m-b-10">Registro de nuevos clientes</h1>
                                        </div>
                                        <div class="page-header-title">
                                            <h5 class="m-b-10"></h5>
                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                &nbsp;&nbsp;&nbsp;<input id="card-holder" type="text" name="descriptxt" class="form-control"  placeholder="Ej: Dinac" aria-label="Card Holder" aria-describedby="basic-addon1"  title="Dinac" id="descri" value="<%= clie.getDesc_clie()%>">
                                                                <%  } else {%>
                                                                &nbsp;&nbsp;&nbsp;<input id="card-holder" type="text" name="descriptxt" class="form-control" placeholder="Ej: Dinac" aria-label="Card Holder" aria-describedby="basic-addon1"  title="Dinac" id="descri" value="">
                                                                <% }%>
                                                                <input type="hidden" name="idtxt" value="<%= clie.getId_clie()%>">
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Documento</label>
                                                                <% if (clie.getNro_doc_clie() != null) {%>
                                                                &nbsp;&nbsp;&nbsp;<input id="card-holder" type="text" name="nroDoctxt" class="form-control" placeholder="Ej: 123456-7" aria-label="Card Holder" aria-describedby="basic-addon1" pattern="[0-9.-]{1,}" title="123456-7" id="documento" value="<%= clie.getNro_doc_clie()%>">
                                                                <%  } else {%>
                                                                &nbsp;&nbsp;&nbsp;<input id="card-holder" type="text" name="nroDoctxt" class="form-control" placeholder="Ej: 123456-7" aria-label="Card Holder" aria-describedby="basic-addon1" pattern="[0-9.-]{1,}" title="123456-7" id="documento" value="">
                                                                <% }%>
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Teléfono</label>                                                                    
                                                                <% if (clie.getTel_clie() != null) {%>
                                                                &nbsp;&nbsp;&nbsp;<input id="card-holder" type="text" name="teltxt" class="form-control" aria-label="Card Holder" placeholder="Ej: +59521606464" aria-describedby="basic-addon1" pattern="[0-9+-]{1,}" title="+59521606464" id="telefono" value="<%= clie.getTel_clie()%>">
                                                                <%  } else {%>
                                                                &nbsp;&nbsp;&nbsp;<input id="card-holder" type="text" name="teltxt" class="form-control" aria-label="Card Holder" placeholder="Ej: +59521606464" aria-describedby="basic-addon1" pattern="[0-9+-]{1,}" title="+59521606464" id="telefono" value="">
                                                                <% }%> 
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">                                                           
                                                            <div class="form-group">
                                                                <label>Email</label>
                                                                <% if (clie.getEmail_clie() != null) {%>
                                                                &nbsp;&nbsp;&nbsp;<input id="card-holder" type="text" name="emailtxt" class="form-control" aria-label="Card Holder" placeholder="Ej: presidente@dinac.gov.py" aria-describedby="basic-addon1" pattern="^[^@]+@[^@]+\.[a-zA-Z]{2,}$" title="presidente@dinac.gov.py" id="email" value="<%= clie.getEmail_clie()%>">
                                                                <%  } else {%>
                                                                &nbsp;&nbsp;&nbsp;<input id="card-holder" type="text" name="emailtxt" class="form-control" aria-label="Card Holder" placeholder="Ej: presidente@dinac.gov.py" aria-describedby="basic-addon1" pattern="^[^@]+@[^@]+\.[a-zA-Z]{2,}$" title="presidente@dinac.gov.py" id="email" value="">
                                                                <% }%> 
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Dirección</label>
                                                                <% if (clie.getDir_clie() != null) {%>
                                                                &nbsp;&nbsp;&nbsp;<input id="card-holder" type="text" name="dirtxt" class="form-control" aria-label="Card Holder" placeholder="Ej: Aviadores del Chaco 2050 - Edificio World Trade Center - Torre 2 Piso 20" aria-describedby="basic-addon1" pattern="[a-z0-9_-.+]{3,}" title="Aviadores del Chaco 2050 - Edificio World Trade Center - Torre 2 Piso 20" id="direccion" value="<%= clie.getDir_clie()%>">
                                                                <%  } else {%>
                                                                &nbsp;&nbsp;&nbsp;<input id="card-holder" type="text" name="dirtxt" class="form-control" aria-label="Card Holder" placeholder="Ej: Aviadores del Chaco 2050 - Edificio World Trade Center - Torre 2 Piso 20" aria-describedby="basic-addon1" pattern="[a-z0-9_-.+]{3,}" title="Aviadores del Chaco 2050 - Edificio World Trade Center - Torre 2 Piso 20" id="direccion" value="">
                                                                <% }%>
                                                            </div>   
                                                                ...
                                                                <select id="drop_bar" name="drop_bar" class="form-control" onChange="update()" >
                                                                    <%
                                                                        ...
                                                                        for (String i : drop.keySet()) {
                                                                            if (clie.getDesc_bar()!= null) {
                                                                                if (drop.get(i).toString().equals(clie.getDesc_bar().toString())) {
