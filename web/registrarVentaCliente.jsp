<%-- 
    Document   : registrarVentaCliente
    Created on : 22/09/2021, 05:31:54 PM
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        <div class="page-header-title">
                                            <h3 class="m-b-10">Seleccionar cliente</h3>
                                        </div>                                        
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-xl-12">
                                        <div class="card">
                                            <div class="card-header">
                                                <h5>Se muestran solo clientes activos</h5>  
                                                <form action="cliente" method="POST">
                                                    ...
                                                    <input type="submit" name="accion" target="_blank" class="btn btn-light action-button" value="Buscar cliente"> 
                                                </form>                                               
                                            </div>
                                            <div class="card-body">
                                                <hr>
                                                                        ...
                                                                        <td class="text-center">
                                                                            ...
                                                                            <div class="container-fluid margin">
                                                                                <form action="venta" method="POST">  <%-- ubicar el form  action de forma que todo lo que se quiere hacer este afectado, con sus inputs --%>                                               
                                                                                    ...
                                                                                    <input type="hidden" name="tp" value="<%= ven.getId_tipo_pago()%>">
                                                                                    <input type="hidden" name="moneda" value="<%= ven.getId_mon()%>">
                                                                                    <input type="submit" name="accion" target="_blank" class="btn btn-warning action-button" value="Ver Contrato">
                                                                                </form>
                                                                            </div> 
                                                                        </td> 
                                                                    </tr>
