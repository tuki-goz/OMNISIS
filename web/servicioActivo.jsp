...
<%
    Servicio clie;
    clie = (Servicio) request.getAttribute("Servicio");
...
<html>
    ...
    <body>
        ...
        <%@ page import="model.Servicio, java.util.ArrayList"  %>
        <%@ page import="controller.cliente"  %>


        <%            ArrayList<Servicio> AA = null;
            AA = (ArrayList<Servicio>) request.getAttribute("ServicioL");
        %>  
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        <div class="page-header-title">
                                            <h3 class="m-b-10">Listado de Servicios Activos</h3>
                                        </div>                                        
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-xl-12">
                                        <div class="card">
                                            <div class="card-header">
                                                ...
                                                <form action="servicio" method="POST">
                                                    <input id="card-holder" type="text" name="buscartxt" class="form-control" placeholder="Descripcion Cliente" aria-label="Card Holder" aria-describedby="basic-addon1" id="descri">
                                                    <br>
                                                            ...
                                                            <table class="table table-hover">
                                                                <thead>
                                                                    <tr>
                                                                        ...
                                                                        <th class="text-center">Número Servicio Técnico</th>
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    %> 
                                                                    <%
                                                                        for (Servicio servicioLL : AA) {
                                                                    %>                                            
                                                                    <tr>  
                                                                        <td class="text-center"> 
                                                                            <%= servicioLL.getId_servicio_tecnico()%>
                                                                        </td>
                                                                        <td class="text-center"> 
                                                                            <%= servicioLL.getNumero_servicio_tecnico()%>
                                                                        </td>                                          
                                                                        <td class="text-center"> 
                                                                            <%= servicioLL.getDescripcion_servicio_tecnico()%>
                                                                        </td> 
                                                                        <td class="text-center"> 
                                                                            <%= servicioLL.getPrecio_servicio_tecnico()%>
                                                                        </td>
                                                                        <td class="text-center"> 
                                                                            <%= servicioLL.getFecha_servicio_tecnnico()%>
                                                                        </td>                                          
                                                                        <td class="text-center"> 
                                                                            <%= servicioLL.getEstado_servicio_tecnico()%>
                                                                        </td>
                                                                        <td class="text-center"> 
                                                                            <%= servicioLL.getUsuario_carga()%>
                                                                        </td>
                                                                        <td class="text-center"> 
                                                                            <%= servicioLL.getCliente_cont()%>
                                                                        </td>
                                                                        <td class="text-center"> 
                                                                            <%= servicioLL.getDesc_cliente()%>
                                                                        </td>
                                                                        <td class="text-center">
                                                                            <%-- no llama al index del array, guarda el id del usuario --%>

                                                                            <div class="container-fluid margin">
                                                                                <form action="servicio" method="POST">  <%-- ubicar el form  action de forma que todo lo que se quiere hacer este afectado, con sus inputs --%>
                                                                                    <input type="hidden" name="codigo" value="<%= servicioLL.getId_servicio_tecnico()%>"> 
                                                                                    <input type="submit" name="accion" target="_blank" class="btn btn-light action-button" value="Cambiar Inactivo">

                                                                                    <input type="hidden" name="codigo2" value="<%= servicioLL.getId_servicio_tecnico()%>">
