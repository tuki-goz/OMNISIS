<%-- 
    Document   : bancoActivo
    Created on : 19/10/2021, 03:41:25 PM
...
<html>
    ...
    <body>    <!-- Sacar ONLOAD para no ALert de mensaje guardado funcion -->
        ...
        <%@ page import="model.Banco, java.util.ArrayList"  %>
        <%@ page import="controller.banco"  %>
        <%            ArrayList<Banco> AA = null;
            AA = (ArrayList<Banco>) request.getAttribute("BancoL");
        %>  
        <div class="loader-bg">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        <div class="page-header-title">
                                            <h3 class="m-b-10">Listado de Bancos Activos</h3>
                                        </div>                                        
                                    </div>
                                </div>
                            </div>
                                                                ...
                                                                <div class="table-responsive">
                                                                    <table class="table table-hover">
                                                                        ...
                                                                        <tr>  
                                                                            ...
                                                                            <td class="text-center"> 
                                                                                <%= bancoLL.getEmail_ban()%>
                                                                            </td>                                 
                                                                            <td class="text-center"> 
                                                                                <%= bancoLL.getTel_ban()%>
                                                                            </td>                                 
                                                                            <td class="text-center"> 
                                                                                <%= bancoLL.getEstado_ban()%>
                                                                            </td>                                                   
                                                                            <td class="text-center">
                                                                                <div class="container-fluid margin">
                                                                                    <form action="banco" method="POST">  <%-- ubicar el form  action de forma que todo lo que se quiere hacer este afectado, con sus inputs --%>
                                                                                        <input type="hidden" name="codigo" value="<%= bancoLL.getId_ban()%>"> 
                                                                                        <input type="submit" name="accion" target="_blank" class="btn btn-light action-button" value="Cambiar Inactivo">
                                                                                        <input type="hidden" name="codigo2" value="<%= bancoLL.getId_ban()%>">
