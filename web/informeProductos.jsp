...
<html>
    ...
    <body>
        ...
        <%@ page import="model.InformeProductos, java.util.ArrayList"  %>
        <%@ page import="controller.informeProductos"  %>


        <%
            ArrayList<InformeProductos> AA = null;
            AA = (ArrayList<InformeProductos>) request.getAttribute("InformeProductosL");
        %>  
        <%
            InformeProductos infp;
            infp = (InformeProductos) request.getAttribute("InformeProductos");
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        <div class="page-header-title">
                                            <h3 class="m-b-10">Informe General de todos los Productos </h3>
                                        </div>                                        
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-xl-12">
                                        <div class="card">
                                            <div class="card-header">
                                                <hr>
                                                <div class="col-6">
                                                    <form name="form1" action="pdfProductos.jsp" target="_blank" method="post"> 
                                                        <div class="form-group">
                                                            <input type="text" name="txtusuario" value="<%= Variables.usuarioConectado.getNumero_usuario()%>" style="color: white; border: none;">
                                                            <br>
                                                            <input type="submit" name="btn1" target="_blank" class="btn btn-success action-button" value="Informe Productos">
                                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                    ...
                                                    <nav class="navbar navbar-dark navbar-expand-md navigation-clean-search">
                                                        <ul class="nav navbar-nav">
                                                            <li class="dropdown">
                                                                ...
                                                                <input  type="hidden" name="txtprueba" class="form-control" aria-label="Card Holder" aria-describedby="basic-addon1"    id="descri" value="<%= infp.getDescripcion_producto()%>">
                                                            </li>                                                                        
