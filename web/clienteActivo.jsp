...
<html>
    ...
    <body>
        ...
        <%            ArrayList<Cliente> AA = null;
            AA = (ArrayList<Cliente>) request.getAttribute("ClienteL");
        %>  
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        <div class="page-header-title">
                                            <h3 class="m-b-10">Listado de Clientes Activos</h3>
                                        </div>                                        
                                    </div>
                                </div>
                            </div>
                                                        ...
                                                        <div class="table-responsive">
                                                            <table class="table table-hover">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    %> 
                                                                    <%
                                                                        for (Cliente clienteLL : AA) {
                                                                    %>                                            
                                                                    <tr>  
                                                                        <td class="text-center"> 
                                                                            <%= clienteLL.getId_clie()%>
                                                                        </td>
                                                                        <td class="text-center"> 
                                                                            <%= clienteLL.getDesc_clie()%>
                                                                        </td>                                          
                                                                        <td class="text-center"> 
                                                                            <%= clienteLL.getNro_doc_clie()%>
                                                                        </td> 
                                                                        <td class="text-center"> 
                                                                            <%= clienteLL.getTel_clie()%>
                                                                        </td>
                                                                        <td class="text-center"> 
                                                                            <%= clienteLL.getEmail_clie()%>
                                                                        </td>                                          
                                                                        <td class="text-center"> 
                                                                            <%= clienteLL.getEstado_clie()%>
                                                                        </td>
                                                                        <td class="text-center"> 
                                                                            <%= clienteLL.getDesc_bar()%>
                                                                        </td>
                                                                        <td class="text-center"> 
                                                                            <%= clienteLL.getDir_clie()%>
                                                                        </td>
                                                                        <td class="text-center">
                                                                            <%-- no llama al index del array, guarda el id del usuario --%>

                                                                            <div class="container-fluid margin">
                                                                                <form action="cliente" method="POST">  <%-- ubicar el form  action de forma que todo lo que se quiere hacer este afectado, con sus inputs --%>
                                                                                    <input type="hidden" name="codigo" value="<%= clienteLL.getId_clie()%>"> 
                                                                                    <input type="submit" name="accion" target="_blank" class="btn btn-light action-button" value="Cambiar Inactivo">

                                                                                    <input type="hidden" name="codigo2" value="<%= clienteLL.getId_clie()%>">
