...
<html>
    ...
    <body>
        ...
        <%            ArrayList<Pais> AA = null;
            AA = (ArrayList<Pais>) request.getAttribute("PaisL");
        %>  
        <div class="loader-bg">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        <div class="page-header-title">
                                            <h3 class="m-b-10">Listado de Paises Activos</h3>
                                        </div>                                        
                                    </div>
                                </div>
                            </div>
                                                        ...
                                                        <div class="table-responsive">
                                                            <table class="table table-hover">
                                                                ...
                                                                <tr>  
                                                                    ...
                                                                    <td class="text-center"> 
                                                                        <%= paisLL.getDescripcion_pais()%>
                                                                    </td>                                          
                                                                    <td class="text-center"> 
                                                                        <%= paisLL.getEstado_pais()%>
                                                                    </td>                                 
                                                                    <td class="text-center">
                                                                        <div class="container-fluid margin">
                                                                            <form action="pais" method="POST">  <%-- ubicar el form  action de forma que todo lo que se quiere hacer este afectado, con sus inputs --%>
                                                                                <input type="hidden" name="codigo" value="<%= paisLL.getId_pais()%>"> 
                                                                                <input type="submit" name="accion" target="_blank" class="btn btn-light action-button" value="Cambiar Inactivo">
                                                                                <input type="hidden" name="codigo2" value="<%= paisLL.getId_pais()%>">
