...
<html>
    ...
    <body>
        ...
        <%            ArrayList<Compra> AA = null;
            AA = (ArrayList<Compra>) request.getAttribute("CompraL");
        %>  
        <div class="loader-bg">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        <div class="page-header-title">
                                            <h3 class="m-b-10">Listado de Compra Realizadas</h3>
                                        </div>                                        
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-xl-12">
                                        <div class="card">
                                            <div class="card-header">
                                                <form action="compra" method="POST">
                                                    <input id="card-holder" type="text" name="buscartxt" class="form-control" placeholder="Buscar por n° de factura" aria-label="Card Holder" aria-describedby="basic-addon1" id="descri">
                                                    <br>                                             
                                                            ...
                                                            <table class="table table-hover">
                                                                <thead>
                                                                    <tr>
                                                                        ...
                                                                        <th class="text-center">Cliente del Contrato:</th>
                                                                    </tr>
                                                                </thead>
                                                                <tbody>
                                                                    <%
                                                                    ...
                                                                    %> 
                                                                    <%
                                                                        for (Compra compraLL : AA) {
                                                                    %>                                            
                                                                    <tr>  
                                                                        <td class="text-center">
                                                                            <div class="container-fluid margin">
                                                                                <form action="ordencompra" method="POST">  
                                                                                    <input type="hidden" name="codigo4" value="<%= compraLL.getId_com()%>"> 
                                                                        ...
                                                                        <td class="text-center"> 
                                                                            <%= compraLL.getProveedor()%>
                                                                        </td>                                          
                                                                        <td class="text-center"> 
                                                                            <%= compraLL.getFecha_com()%>
                                                                        </td>                               
                                                                        <td class="text-center"> 
                                                                            <%= compraLL.getTotal_com()%>
                                                                        </td>                               
                                                                        <td class="text-center"> 
                                                                            <%= compraLL.getEstado_com()%>
                                                                        </td>                                
                                                                        <td class="text-center"> 
                                                                            <%= compraLL.getCont_clie()%>
                                                                        </td>                                      
                                                                    </tr>
                                                                    <% } %>
                                                                    <% } %>
