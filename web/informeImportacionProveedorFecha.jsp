<%-- 
    Document   : informeImportacionProveedorFecha
    Created on : 13/12/2021, 09:36:25 PM
...
<html>
    <head>
        <title>Informe de Importaciones</title>
...
<script type="text/javascript">
    ...
    <body>
        ...
        <%@ page import="model.InformeImportaciones, java.util.ArrayList"  %>
        <%@ page import="controller.informeImportaciones"  %>
        <%
            ArrayList<InformeImportaciones> AA = null;
            AA = (ArrayList<InformeImportaciones>) request.getAttribute("InformeImportacionesL");
        %>  
        <%
            InformeImportaciones infimp;
            infimp = (InformeImportaciones) request.getAttribute("InformeImportaciones");
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        <div class="page-header-title">
                                            <h3 class="m-b-10">Informe de Importaciones por Proveedor y Fecha</h3>
                                        </div>                                        
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-xl-12">
                                        <div class="card">
                                            <div class="card-header">
                                                <hr>
                                                <div class="col-6">
                                                    <form name="form1" action="pdfImportProveedorFecha.jsp" target="_blank" method="post"> 
                                                        <div class="col-8">
                                                            <input type="text" name="txtparametro" class="form-control" placeholder="Nombre del Proveedor"> 
                                                            <br>
                                                            ...
                                                            <br>
                                                            <input type="submit" name="btn1" target="_blank" class="btn btn-success action-button" value="Informe de Importaciones">
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
                                                    ...
                                                    <nav class="navbar navbar-dark navbar-expand-md navigation-clean-search">
                                                        <ul class="nav navbar-nav">
                                                            <li class="dropdown">
                                                                ...
                                                                <input  type="hidden" name="txtprueba" class="form-control" aria-label="Card Holder" aria-describedby="basic-addon1"    id="descri" value="<%= infimp.getLlamado()%>">
                                                            </li>                                                                        
                                                        </ul>
                                                    </nav>
                                                </div>
