<%-- 
    Document   : tipo_de_pagoActivo
    Created on : 13/10/2021, 12:10:02 AM
...
<html>
    ...
    <body>
        <%@ page import="model.Tipo_pago, java.util.ArrayList"  %>
        <%@ page import="controller.tipo_pago"  %>
        <%            ArrayList<Tipo_pago> AA = null;
            AA = (ArrayList<Tipo_pago>) request.getAttribute("TipoPagoL");
        %>  
        <div class="loader-bg">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        <div class="page-header-title">
                                            <h3 class="m-b-10">Listado de Tipo de Pagos</h3>
                                        </div>                                        
                                    </div>
                                </div>
                            </div>
                                                        ...
                                                        <div class="table-responsive">
                                                            <table class="table table-hover">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    %> 
                                                                    <%
                                                                        for (Tipo_pago tipo_pagoLL : AA) {
                                                                    %>                                            
                                                                    <tr>  
                                                                        <td class="text-center"> 
                                                                            <%= tipo_pagoLL.getId_tp()%>
                                                                        </td>
                                                                        <td class="text-center"> 
                                                                            <%= tipo_pagoLL.getDescrip_tp()%>
                                                                        </td>                             
                                                                        <td class="text-center">
                                                                            <div class="container-fluid margin">
                                                                                <form action="tipo_pago" method="POST">
                                                                                    <input type="hidden" name="codigo2" value="<%= tipo_pagoLL.getId_tp()%>">
