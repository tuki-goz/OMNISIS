<%-- 
    Document   : cierre
    Created on : 25/09/2021, 11:19:17 AM
    Author     : Francisca Gómez
--%>
<%@page import="java.util.HashMap"%>
<%@page import="model.Variables"%>
<%@page contentType="text/html" pageEncoding="UTF-8"%>
<%@page import="model.Apertura_Cierra"%>
<%
    Apertura_Cierra aper_cie;
    aper_cie = (Apertura_Cierra) request.getAttribute("Apertura_Cierre");
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        <div class="page-header-title">
                                            <h1 class="m-b-10">Arqueos - Registrar cierre</h1>
                                        </div>
                                        <div class="page-header-title">
                                            <h5 class="m-b-10"></h5>
                                        </div>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <hr>
                                                <form action="apertura_cierre" method="POST">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <%----------------------------------------------------------------- --%>
                                                            <div class="form-group"> 
                                                                <h5 class="mt-5">Apertura</h5>
                                                                <script>
                                                                    var f = new Date();
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group "> 
                                                                ...
                                                                <input id="card-holder" type="text" name="estadotxt" class="form-control" readonly="true" aria-label="Card Holder" aria-describedby="basic-addon1" value="<%= Variables.estado_caja_abierta %>">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group "> 
                                                                <h5 class="mt-5">Caja:</h5>
                                                                <input id="card-holder" type="text" name="cajatxt" class="form-control"readonly="true" aria-label="Card Holder" aria-describedby="basic-addon1" value="<%= Variables.nom_caja_abierta%>">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group "> 
                                                                <h5 class="mt-5">Usuario operador:</h5>
                                                                <input id="card-holder" type="text" name="usutxt" class="form-control" readonly="true" aria-label="Card Holder" aria-describedby="basic-addon1" value="<%= Variables.usuario1%>">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group "> 
                                                                <h5 class="mt-5">Monto Cierre:</h5>
                                                                <input id="card-holder" type="text" name="montocietxt" required="true" class="form-control" aria-label="Card Holder" aria-describedby="basic-addon1" readonly="true" value="<%= Variables.venta_diaria %>">
                                                            </div>
                                                        </div>
                                                            <div class="col-md-6">
                                                            <div class="form-group "> 
                                                                <h5 class="mt-5">Monto Apertura:</h5>
                                                                <input id="card-holder" type="text" name="montocietxt" required="true" class="form-control" aria-label="Card Holder" aria-describedby="basic-addon1"  readonly="true" value="<%= Variables.montoapertura %>">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="container-fluid margin">                                                        
                                                        <button type="submit" name="accion" target="_blank" class="btn btn-dark action-button" value="Grabar ">Grabar</button>
                                                        <input type="submit" name="accion" target="_blank" class="btn btn-info action-button" value="Atras">
