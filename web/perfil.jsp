...
<%
    Perfil per;
    per = (Perfil) request.getAttribute("Perfil");
%>
<!DOCTYPE html>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        <div class="page-header-title">
                                            <h1 class="m-b-10">Registrar nuevo perfil</h1>
                                        </div>
                                        <div class="page-header-title">
                                            <h5 class="m-b-10"></h5>
                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="form-group"> 
                                                                ...
                                                                <% if (per.getDescrip_perfil() != null) {%>
                                                                <input id="card-holder" type="text" name="descriptxt" class="form-control" placeholder="Ej: Jefe de Area Tecnica" aria-label="Card Holder" aria-describedby="basic-addon1" pattern="[[A-Z]{0,}[a-z]{0,}\D{1,}" title="Jefe de Area Tecnica" id="descri" value="<%= per.getDescrip_perfil()%>">
                                                                <%  } else {%>
                                                                <input id="card-holder" type="text" name="descriptxt" class="form-control" placeholder="Ej: Jefe de Area Tecnica" aria-label="Card Holder" aria-describedby="basic-addon1" pattern="[[A-Z]{0,}[a-z]{0,}\D{1,}" title="Jefe de Area Tecnica" id="descri" value="">
                                                                <% }%>
                                                                <input id="card-holder" type="hidden" name="idtxt" class="form-control" aria-label="Card Holder" aria-describedby="basic-addon1" value="<%= per.getId_perfil()%>">
                                                                ...
                                                                <br>
                                                                    ...
                                                                    <div class="custom-control custom-radio">
                                                                        <% if (per.getEstado_perfil() == "activo") {%>
                                                                        <div class="custom-control custom-radio">
                                                                        ...
                                                                        <% }%>
                                                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                                        <% if (per.getEstado_perfil() == "inactivo") {%>
                                                                        <div class="custom-control custom-radio">
