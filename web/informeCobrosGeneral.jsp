...
<html>
    ...
    <body>
        ...
        <%
            InformeCobros infv;
            infv = (InformeCobros) request.getAttribute("InformeCobros");
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        <div class="page-header-title">
                                            <h3 class="m-b-10">Informe de Cobros General</h3>
                                        </div>                                        
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-xl-12">
                                        <div class="card">
                                            <div class="card-header">
                                                <hr>
                                                <div class="col-6">
                                                    <form name="form1" action="pdfCobroGeneralPendiente.jsp" target="_blank" method="post"> 
                                                        <input type="text" name="txtusuario" value="<%= Variables.usuarioConectado.getNumero_usuario()%>" style="color: white; border: none;">
                                                        <div class="form-group">
                                                            <input type="hidden" name="txtparametro" class="form-control" placeholder="Descripcion del cliente"> 
                                                            <input type="submit" name="btn1" target="_blank" class="btn btn-success action-button" value="Informe Cobros Pendientes">
                                                        </div>
                                                    </form>
                                                    <hr>    
                                                    <form name="form1" action="pdfCobroGeneralCancelado.jsp" target="_blank" method="post"> 
                                                        <input type="text" name="txtusuario" value="<%= Variables.usuarioConectado.getNumero_usuario()%>" style="color: white; border: none;">
                                                        <div class="form-group">
                                                            <br>
                                                            <input type="hidden" name="txtparametro" class="form-control" placeholder="Descripcion del cliente">                                                           
                                                            <input type="submit" name="btn1" target="_blank" class="btn btn-success action-button" value="Informe Cobros Cancelados">
                                                        </div>
                                                    </form>
                                                    ...
                                                    <nav class="navbar navbar-dark navbar-expand-md navigation-clean-search">
                                                        <ul class="nav navbar-nav">
                                                            <li class="dropdown">
                                                                ...
                                                                <input  type="hidden" name="txtprueba" class="form-control" aria-label="Card Holder" aria-describedby="basic-addon1"    id="descri" value="<%= infv.getNombre_razon()%>">
                                                            </li>                                                                        
