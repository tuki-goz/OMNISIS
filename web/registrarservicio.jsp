...
<%
    Servicio ser;
    ser = (Servicio) request.getAttribute("Servicio");
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        <div class="page-header-title">
                                            <h1 class="m-b-10">Registro de nuevos servicios</h1>
                                        </div>
                                        <div class="page-header-title">
                                            <h5 class="m-b-10"></h5>
                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <% if (ser.getNumero_servicio_tecnico() != null) {%> 
                                                                &nbsp;&nbsp;&nbsp;<input id="card-holder" type="text" name="numerotxt" class="form-control" placeholder="Ej: 01" aria-label="Card Holder" aria-describedby="basic-addon1" pattern="[0-9]{1,}" title="01" id="numero" value="<%= ser.getNumero_servicio_tecnico()%>">
                                                                <%  } else {%>
                                                                ...
                                                                <% }%>
                                                                <input id="card-holder" type="hidden" name="idtxt" class="form-control" aria-label="Card Holder" aria-describedby="basic-addon1" value="<%= ser.getId_servicio_tecnico()%>">
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Descripción de pedido</label>
                                                                <% if (ser.getDescripcion_servicio_tecnico() != null) {%> 
                                                                &nbsp;&nbsp;&nbsp;<input id="card-holder" type="text" name="descriptxt" class="form-control" placeholder="Ej: Mantenimiento de Scanner movil" aria-label="Card Holder" aria-describedby="basic-addon1"  title="Dolar" id="descri" value="<%= ser.getDescripcion_servicio_tecnico()%>">
                                                                <%  } else {%>
                                                                &nbsp;&nbsp;&nbsp;<input id="card-holder" type="text" name="descriptxt" class="form-control" placeholder="Ej: Mantenimiento de Scanner movil" aria-label="Card Holder" aria-describedby="basic-addon1"  title="Dolar" id="descri" value="">
                                                                <% }%>
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Notas</label>
                                                                <% if (ser.getNotas() != null) {%> 
                                                                &nbsp;&nbsp;&nbsp;<input id="card-holder" type="text" name="notastxt" class="form-control" aria-label="Card Holder" placeholder="Ej: Mantenimiento de Scanner movil..." aria-describedby="basic-addon1" pattern="[a-z0-9_-.+]{3,}" title="Mantenimiento de Scanner movil..." id="notas" value="<%= ser.getNotas()%>">
                                                                <%  } else {%>
                                                        ...
                                                        <div class="col-md-2">
                                                            <div class="form-group">
                                                                <label>Precio</label>
                                                                &nbsp;&nbsp;&nbsp;<input type="number" name="preciotxt" class="form-control"  value="150000" onchange="cal()" onkeyup="cal()" /></p>


                                                                <label>Fecha</label>
                                                                <% if (ser.getFecha_servicio_tecnnico() != null) {%>  
                                                                <input type="date" name="fechasertxt" id="fechaActual" class="form-control"  value="<%= ser.getFecha_servicio_tecnnico()%>">
                                                                <%  } else {%>
                                                                <input type="date" name="fechasertxt" class="form-control"  id="fechaActual">
                                                                <% }%>                                                           
                                                            </div>  
                                                            <script>
                                                                ...
                                                                <select id="dropts_ts" name="dropts_ts" class="form-control" onChange="update()" >
                                                                    ...
                                                                    <%Tiposervicio ts = new Tiposervicio();
                                                                        ...
                                                                        for (String i : dropts_ts.keySet()) {
                                                                            if (ser.getDescr_tipo_ser() != null) {
                                                                                if (dropts_ts.get(i).toString().equals(ser.getDescr_tipo_ser().toString())) {
                                                            ...
                                                            <div class="form-group">
                                                                <label for="card-holder">Usuario que carga</label>
                                                                <select id="dropusu_usu" name="dropusu_usu" class="form-control" onChange="update()" >
                                                                    <%
                                                                        ...
                                                                        for (String i : dropusu.keySet()) {
                                                                            if (ser.getUsuario_carga() != null) {
                                                                                if (dropusu.get(i).toString().equals(ser.getUsuario_carga().toString())) {
                                                                ...
                                                                <select id="drop_cont" name="drop_cont" class="form-control" onChange="update()" >
                                                                    <%
                                                                        ...
                                                                        for (String i : drop_cont.keySet()) {
                                                                            if (ser.getCod_contrado() != null) {
                                                                                if (drop_cont.get(i).toString().equals(ser.getCod_contrado().toString())) {
                                                            ...
                                                            <select id="drop_clie" name="drop_clie" class="form-control" onChange="update()" >
                                                                <%
                                                                    ...
                                                                    for (String i : drop_clie.keySet()) {
                                                                        if (ser.getDesc_cliente() != null) {
                                                                            if (drop_clie.get(i).toString().equals(ser.getDesc_cliente().toString())) {
