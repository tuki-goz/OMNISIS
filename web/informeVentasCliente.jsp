<%-- 
    Document   : informeVentasCliente
    Created on : 8/12/2021, 08:03:24 PM
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        <div class="page-header-title">
                                            <h3 class="m-b-10">Informe de Ventas con Pagos por Cliente</h3>
                                        </div>                                        
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-xl-12">
                                        <div class="card">
                                            <div class="card-header">
                                                <div class="row">
                                                    <form name="form1" action=pdf_infventclie.jsp" target="_blank" method="post">                                                        
                                                        ...
                                                        <br>
                                                        <input type="submit" name="btn1" target="_blank" class="btn btn-success action-button" value="Buscar Solo Cliente">
                                                    </form>
                                                </div>
                                                <form action="informeVentas" method="POST">                                                    
                                                    <div>
