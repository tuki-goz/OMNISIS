<%-- 
    Document   : timbradoInactivo
    Created on : 31/10/2021, 04:53:32 PM
...
<html>
    <head>
        <title>Timbrados Inactivos</title>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        <div class="page-header-title">
                                            <h3 class="m-b-10">Listado de Timbrados Inactivos</h3>
                                        </div>                                        
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-xl-12">
                                        <div class="card">
                                            <div class="card-header">
                                                <br>
                                                <form action="timbrado" method="POST">                                                    
                                                    <input id="card-holder" type="text" name="buscartxt" class="form-control" placeholder="Buscar por numero de timbrado" aria-label="Card Holder" aria-describedby="basic-addon1" id="descri">
                                                    <br>
