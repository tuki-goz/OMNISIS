<%-- 
    Document   : aprobaciondecompramodificado
    Created on : 24/08/2021, 08:45:26 PM
    ...
    <body>
        ...
        <div class="container">
            <div class="error-wrapper">
                ...
                <p class="info">He modificado correctamente los datos de la aprobacion de compras</p>
