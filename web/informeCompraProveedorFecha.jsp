<%-- 
    Document   : informeCompra
    Created on : 20/09/2021, 03:56:03 PM
    Author     : Alvaro
--%>
...
<html>
    ...
    <body>
        ...
        <%@ page import="model.InformeCompra, java.util.ArrayList"  %>
        <%@ page import="controller.informeCompra"  %>
        <%
            ArrayList<InformeCompra> AA = null;
            AA = (ArrayList<InformeCompra>) request.getAttribute("InformeCompraL");
        %>  
        <div class="loader-bg">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        <div class="page-header-title">
                                            <h3 class="m-b-10">Informe de compras por Proveedor y Fecha</h3>
                                        </div>                                        
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-xl-12">
                                        <div class="card">
                                            <div class="card-header">
                                                <hr>
                                                <form name="form1" action="pdfCompraProveedorFecha.jsp" target="_blank" method="post">  
                                                    <div class="col-6">
                                                        ...
                                                        <br>
                                                        <input type="submit" name="btn1" target="_blank" class="btn btn-success action-button" value="Informe Compras">                                                            
                                                    </div>
                                                </form>
                                            </div>
                                            <hr>
