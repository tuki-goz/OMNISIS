<%-- 
    Document   : ordencompraCancelado
    Created on : 5/11/2021, 03:31:37 PM
...
<html>
    <head>
        <title>Orden de Compra Cancelados</title>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        <div class="page-header-title">
                                            <h3 class="m-b-10">Listado de Orden de Compra Cancelados</h3>
                                        </div>                                        
                                    </div>
                                </div>
                            </div>
