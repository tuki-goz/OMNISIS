<%-- 
    ...
    Created on : 21/09/2021, 11:14:27 AM
                                                            ...
                                                            <table class="table table-hover">
                                                                <thead>
                                                                    <tr>
                                                                        ...
                                                                        <th class="text-center">Cantidad a Facturar&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Opción&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
                                                                    </tr>
                                                                </thead>
                                                                <tbody>
                                                                        ...
                                                                        <td class="text-center">
                                                                            <div class="container-fluid margin">
                                                                                <form action="venta" method="POST">  
                                                                                    ...
                                                                                    <input type="submit" name="accion" class="btn btn-warning action-button" value="Seleccionar">                                                                                    
                                                                                </form>
                                                                            </div> 
                                                                        </td> 
                                                                    </tr>
