<%-- 
    Document   : informeServiciosCliente
    Created on : 13/12/2021, 10:34:48 AM
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        <div class="page-header-title">
                                            <h3 class="m-b-10">Informe de Servicios Activos por Contrato</h3>
                                        </div>                                        
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-xl-12">
                                        <div class="card">
                                            <div class="card-header">
                                                <div class="col-8">
                                                    <form name="form1" action="pdfServiciosporContrato.jsp" target="_blank" method="post"> 
