                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        <div class="page-header-title">
                                            <h1 class="m-b-10">Registrar nuevo pais</h1>
                                        </div>
                                        <div class="page-header-title">
                                            <h5 class="m-b-10"></h5>
                                        </div>
                                                ...
                                                <form action="pais" method="POST">
                                                    <div class="row">
                                                        <div class="col-3 text-center">
                                                            ...
                                                            <% if (p.getDescripcion_pais() != null) {%>  
                                                            <input id="card-holder" type="text" name="descriptxt" class="form-control" placeholder="Nombre del pais" aria-label="Card Holder" aria-describedby="basic-addon1" pattern="[[A-Z]{0,}[a-z]{0,}\D{1,}" id="descri" value="<%=p.getDescripcion_pais()%>" autofocus>
                                                            <%  } else {%>
                                                            <input id="card-holder" type="text" name="descriptxt" class="form-control" placeholder="Nombre del pais" aria-label="Card Holder" aria-describedby="basic-addon1" pattern="[[A-Z]{0,}[a-z]{0,}\D{1,}" id="descri" value="" autofocus>
                                                            <% }%>                                    
