                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        <div class="page-header-title">
                                            <h3 class="m-b-10">Informe de Cobros Pendientes por Cliente y Fecha</h3>
                                        </div>                                        
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <div class="card-header">
                                                ...
                                                <form name="form1" action="pdfContratosporClienteFecha.jsp" target="_blank" method="post"> 
                                                    <div class="col-md-6">
                                                        ...
                                                        <input type="submit" name="btn1" target="_blank" class="btn btn-success action-button" value="Informe de Cobros Pendientes por Cliente y Fecha">
                                                    </div>
                                                </form>
