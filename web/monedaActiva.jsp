<%-- 
    Document   : monedaActiva
    Created on : 13/10/2021, 10:19:14 AM
...
<html>
    ...
    <body>
        <%@ page import="model.Moneda, java.util.ArrayList"  %>
        <%@ page import="controller.moneda"  %>
        <%            ArrayList<Moneda> AA = null;
            AA = (ArrayList<Moneda>) request.getAttribute("MonedaL");
        %>  
        <div class="loader-bg">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        <div class="page-header-title">
                                            <h3 class="m-b-10">Listado de Monedas Activas</h3>
                                        </div>                                        
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="card">
                                            ...
                                            <div>
                                                ...
                                                <div class="alert alert-warning alert-dismissible fade show text-center" role="alert" style="float: top;">
                                                    <strong>Genial!</strong> El departamento ha sido guardado.
                                            ...
                                            <div>
                                                ...
                                                <div class="alert alert-secondary alert-dismissible fade show text-center" role="alert" style="float: top;">
                                                    <strong>Genial!</strong> El departamento ha sido modificado.
                                                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                                        Ok
                                                    </button>
                                                </div>
                                                            ...
                                                            <table class="table table-hover">
                                                                <thead>
                                                                    <tr>
                                                                        ...
                                                                        <th class="text-center">Cot. Compra:</th>
                                                                        <th class="text-center">Cot. Venta:</th>
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    %> 
                                                                    <%
                                                                        for (Moneda monedaLL : AA) {
                                                                    %>                                            
                                                                    <tr>  
                                                                        <td class="text-center"> 
                                                                            <%= monedaLL.getId_moneda()%>
                                                                        </td>
                                                                        <td class="text-center"> 
                                                                            <%= monedaLL.getDesc_moneda()%>
                                                                        </td>                                          
                                                                        <td class="text-center"> 
                                                                            <%= monedaLL.getFecha_mon()%>
                                                                        </td>                                          
                                                                        <td class="text-center"> 
                                                                            <%= monedaLL.getCoti_compra_actual_moneda()%>
                                                                        </td>                               
                                                                        <td class="text-center"> 
                                                                            <%= monedaLL.getCoti_venta_actual_moneda()%>
                                                                        </td>                               
                                                                        <td class="text-center"> 
                                                                            <%= monedaLL.getEstado_moneda()%>
                                                                        </td>                               
                                                                        <td class="text-center">
                                                                            <div class="container-fluid margin">
                                                                                <form action="moneda" method="POST">  <%-- ubicar el form  action de forma que todo lo que se quiere hacer este afectado, con sus inputs --%>
                                                                                    <input type="hidden" name="codigo" value="<%= monedaLL.getId_moneda()%>"> 
                                                                                    
                                                                                    <input type="hidden" name="codigo2" value="<%= monedaLL.getId_moneda()%>">
