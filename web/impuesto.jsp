...
<%
    Impuesto im;
    im = (Impuesto) request.getAttribute("Impuesto");
%>
<!DOCTYPE html>
<html>
    <head>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        <div class="page-header-title">
                                            <h1 class="m-b-10">Registrar nuevo impuesto</h1>
                                        </div>
                                        <div class="page-header-title">
                                            <h5 class="m-b-10"></h5>
                                        </div>
                                                ...
                                                <form action="impuesto" method="POST">
                                                    <div class="row">
                                                        <div class="col-3 text-center">
                                                            ...
                                                            <% if (im.getDescripcion_impuesto() != null) {%>  
                                                            <input id="card-holder" type="text" name="descripimptxt" class="form-control" placeholder="Nombre de la moneda" aria-label="Card Holder" aria-describedby="basic-addon1" pattern="[[A-Z]{0,}[a-z]{0,}{1,}" id="descri" value="<%=im.getDescripcion_impuesto()%>">
                                                            <%  } else {%>
                                                            <input id="card-holder" type="text" name="descripimptxt" class="form-control" placeholder="Nombre de la moneda" aria-label="Card Holder" aria-describedby="basic-addon1" pattern="[[A-Z]{0,}[a-z]{0,}{1,}" id="descri" value="">
                                                            <% }%>                                    
                                                            <input id="card-holder" type="hidden" name="idtxt" class="form-control" aria-label="Card Holder" aria-describedby="basic-addon1" value="<%= im.getId_impuesto()%>">                                                          
                                                        </div>
                                                        <div class="col-3 text-center">
                                                            <h6 class="text-capitalize">Cifra</h6>  
                                                            <% if (im.getCifra() != 0) {%>  
                                                            <input id="card-holder" type="text" name="cifratxt" class="form-control" placeholder="Cantidad de la cifra" aria-label="Card Holder" aria-describedby="basic-addon1" pattern="[[0-9]{0,}]" id="descri" value="<%=im.getCifra()%>">
                                                            <%  } else {%>
                                                            <input id="card-holder" type="text" name="cifratxt" class="form-control" placeholder="Cantidad de la cifra" aria-label="Card Holder" aria-describedby="basic-addon1" pattern="[[0-9]{0,}]" id="descri" value="">
                                                            <% }%>     
                                                        </div>
                                                        <div class="col-3 text-center">
                                                            <label for="card-holder" class="text-capitalize">Estado</label> 
                                                            <div class="custom-control custom-radio">
                                                                <% if (im.getEstado_im() == "activo") {%>
                                                                <div class="custom-control custom-radio">
