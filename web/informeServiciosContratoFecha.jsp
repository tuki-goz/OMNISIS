<%-- 
    Document   : informeServiciosClienteFecha
    Created on : 13/12/2021, 10:34:36 AM
...
<html>
    ...
    <body>
        ...
        <%@ page import="model.InformeServicios, java.util.ArrayList"  %>
        <%@ page import="controller.informeVentas"  %>
        <%
            ArrayList<InformeServicios> AA = null;
            AA = (ArrayList<InformeServicios>) request.getAttribute("InformeServiciosL");
        %>  
        <%
            InformeServicios infs;
            infs = (InformeServicios) request.getAttribute("InformeServicios");
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        <div class="page-header-title">
                                            <h3 class="m-b-10">Informe de Servicios Activos por Cliente y Fecha</h3>
                                        </div>                                        
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-xl-12">
                                        <div class="card">
                                            <div class="card-header">
                                                <div class="col-8">
                                                    <form name="form1" action="pdfServiciosporContratoFecha.jsp" target="_blank" method="post"> 
                                                        <div class="form-group "> <%-- agregar espacio entre los labels &nbsp --%>
                                                            <input type="text" name="txtparametro" class="form-control" placeholder="Codigo del Contrato">
                                                            <br>
                                                            <div>
                                                        ...
                                                        <br>
                                                        <input type="submit" name="btn1" target="_blank" class="btn btn-success action-button" value="Informe de Servicios">
                                                    </form>                                  
                                                </div>
                                            </div>
                                            <hr>
                                                    ...
                                                    <nav class="navbar navbar-dark navbar-expand-md navigation-clean-search">
                                                        <ul class="nav navbar-nav">
                                                            <li class="dropdown">
                                                                ...
                                                                <input  type="hidden" name="txtprueba" class="form-control" aria-label="Card Holder" aria-describedby="basic-addon1"    id="descri" value="<%= infs.getCod_contrado()%>">
                                                            </li>                                                                        
                                                        </ul>
                                                    </nav>
                                                </div>
