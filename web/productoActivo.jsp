                                                            ...
                                                            <table class="table table-hover">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>  
                                                                        ...
                                                                        <td class="text-center">
                                                                            <%-- no llama al index del array, guarda el id del producto --%>

                                                                            <div class="container-fluid margin">
                                                                                <form action="producto" method="POST">  <%-- ubicar el form  action de forma que todo lo que se quiere hacer este afectado, con sus inputs --%>
                                                                                    <input type="hidden" name="codigo" value="<%= productoLL.getId_producto()%>"> 
                                                            ...
                                                            <ul class="nav navbar-nav">
                                                                <form action="producto" method="POST">
                                                                    <li class="dropdown">
                                                                        ...
                                                                        <input type="submit" name="accion" target="_blank" class="btn btn-light action-button" value="Inactivo"></span>
                                                                    </li>                                                                        
                                                                </form>
                                                            </ul>
                                                        </nav>
