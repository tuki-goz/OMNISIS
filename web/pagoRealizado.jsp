<%-- 
    ...
    Created on : 5/11/2021, 10:33:24 PM
...
<html>
    ...
    <body>
        ...
        <%
            ArrayList<Pago> AA = null;
            AA = (ArrayList<Pago>) request.getAttribute("PagoL");
        %>  
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        <div class="page-header-title">
                                            <h3 class="m-b-10">Listado de Pagos Realizados</h3>
                                        </div>                                        
                                    </div>
                                </div>
                            </div>
                                                            ...
                                                            <table class="table table-hover">
                                                                <thead>
                                                                    <tr>
                                                                        ...
                                                                        <th class="text-center">Recibo de Transferencia:</th>                                                                   
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="text-center"> 
                                                                            <%= pagoLL.getDescrip_pag()%>
                                                                        </td>                                 
                                                                        <td class="text-center"> 
                                                                            <%= pagoLL.getFecha_pag()%>
                                                                        </td>                                 
                                                                        <td class="text-center"> 
                                                                            <%= pagoLL.getTotal_pago()%>
                                                                        </td>
                                                                        <td class="text-center"> 
                                                                            <%= pagoLL.getDescrip_cta_pag()%>
                                                                        </td>                                          
                                                                        <td class="text-center"> 
                                                                            <%= pagoLL.getDescrip_tp()%>
                                                                        </td>                            
                                                                    ...
                                                                    <td class="text-center">
                                                                        <div class="container-fluid margin">
                                                                            <form action="pago" method="POST"> 
                                                                                <input type="hidden" name="codigo2" value="<%= pagoLL.getId_pag()%>">
