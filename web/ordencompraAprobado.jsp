<%-- 
    Document   : ordencompraAprobado
    Created on : 5/11/2021, 03:27:11 PM
...
<html>
    <head>
        <title>Orden de Compra Aprobadas</title>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        <div class="page-header-title">
                                            <h3 class="m-b-10">Listado de Orden de Compra Aprobadas</h3>
                                        </div>                                        
                                    </div>
                                </div>
                            </div>
