...
<html>
    ...
    <body>
        <%@ page import="model.Usuario01, java.util.ArrayList"  %>
        <%@ page import="controller.usuario"  %>
        <%            ArrayList<Usuario01> AA = null;
            AA = (ArrayList<Usuario01>) request.getAttribute("Usuario01L");
        %>  
        <div class="loader-bg">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        <div class="page-header-title">
                                            <h3 class="m-b-10">Listado de Usuarios Activos</h3>
                                        </div>                                        
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-xl-12">
                                        <div class="card">
                                            <div class="card-header">                                                
                                                <form action="usuario" method="POST">
                                                    <input id="card-holder" type="text" name="buscartxt" class="form-control" placeholder="Nombre de usuario" aria-label="Card Holder" aria-describedby="basic-addon1">
                                                    <br>
                                                        ...
                                                        <div class="table-responsive">
                                                            <table class="table table-hover">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    %> 
                                                                    <%
                                                                        for (Usuario01 usuarioLL : AA) {
                                                                    %>                                            
                                                                    <tr>  
                                                                        <td class="text-center"> 
                                                                            <%= usuarioLL.getId_usua()%>
                                                                        </td>
                                                                        <td class="text-center"> 
                                                                            <%= usuarioLL.getNom_usu()%>
                                                                        </td>                                          
                                                                        <td class="text-center"> 
                                                                            <%= usuarioLL.getEmail_usu()%>
                                                                        </td> 
                                                                        <%--
                                                                        <td class="text-center"> 
                                                                            <%= usuarioLL.getClave_usu()%>
                                                                        </td>
                                                                        --%>
                                                                        <td class="text-center"> 
                                                                            <%= usuarioLL.getEstado_usu()%>
                                                                        </td>                                          
                                                                        <td class="text-center"> 
                                                                            <%= usuarioLL.getDescr_per()%>
                                                                        </td>
                                                                        <td class="text-center"> 
                                                                            <%= usuarioLL.getDescr_fun()%>
                                                                        </td>
                                                                        <td class="text-center">
                                                                            <%-- no llama al index del array, guarda el id del usuario --%>

                                                                            <div class="container-fluid margin">
                                                                                <form action="usuario" method="POST">  <%-- ubicar el form  action de forma que todo lo que se quiere hacer este afectado, con sus inputs --%>
                                                                                    <input type="hidden" name="codigo" value="<%= usuarioLL.getId_usua()%>"> 
                                                                                    <input type="submit" name="accion" target="_blank" class="btn btn-light action-button" value="Cambiar Inactivo">

                                                                                    <input type="hidden" name="codigo2" value="<%= usuarioLL.getId_usua()%>">
