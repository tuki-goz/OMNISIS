...
<html>
    <head>
        <title>Todos los contratos</title>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        <div class="page-header-title">
                                            <h3 class="m-b-10">Registro de contratos inactivos</h3>
                                        </div>                                        
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-xl-12">
                                        <div class="card">
                                            <div class="card-header">
                                                <h5>Todos los contratos inactivos</h5>                                             
                                            </div>
                                            <form action="contrato" method="POST"> 
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>   
                                                                    ...
                                                                    <td class="text-center"> 
                                                                        ...
                                                                        <input type="hidden" name="idtxt2" value="<%= contratoLL.getId_contrato()%>">
                                                                    </td>
                                                                </tr>
                                                                <% } %>
                                                                <% } %>
    ...
    <body>
        ...
        <form action="contrato" method="POST">
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title"> Contrato Activos </h4>
                    </div>
                    <div class="card-body">
                        ...
                        <table class="table">
                            <thead class=" text-primary">
                                <tr>
                                    <th class="text-center">Opción:</th>
                                    <th class="text-center">Cliente contrato</th>
