...
<%
    TipoContrato p;
    p = (TipoContrato) request.getAttribute("TipoContrato");
...
<html>
    <head>
        <title>Tipos de Contratos Activos</title>
    ...
    <body>
        <%@ page import="model.TipoContrato, java.util.ArrayList"  %>
        <%@ page import="controller.tipocontrato"  %>
        <%            ArrayList<TipoContrato> AA = null;
            AA = (ArrayList<TipoContrato>) request.getAttribute("TipoContratoL");
        %>  
        <div class="loader-bg">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        <div class="page-header-title">
                                            <h3 class="m-b-10">Listado de Tipo de Contratos Activos</h3>
                                        </div>                                        
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-xl-12">
                                        <div class="card">
                                            <div class="card-header">
                                                ...
                                                <form action="tipocontrato" method="POST">                                                    
                                                    <input id="card-holder" type="text" name="buscartxt" class="form-control" placeholder="Descripcion" aria-label="Card Holder" aria-describedby="basic-addon1" id="descri">
                                                    <br>
                                            ...
                                            <div>
                                                ...
                                                <div class="alert alert-warning alert-dismissible fade show text-center" role="alert" style="float: top;">
                                                    <strong>Genial!</strong> Ha sido registrado.
                                            ...
                                            <div>
                                                ...
                                                <div class="alert alert-secondary alert-dismissible fade show text-center" role="alert" style="float: top;">
                                                    <strong>Perfecto!</strong> Todo perfecto.
                                                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                                        <i class="fas fa-times"></i>
                                                    </button>
                                                </div>
                                                    ...
                                                    <div class="card-block table-border-style">
                                                        <div class="table-responsive">
                                                            <table class="table table-hover">
                                                                ...
                                                                %> 
                                                                <%
                                                                    for (TipoContrato tipocontratoLL : AA) {
                                                                %>                                            
                                                                <tr>  
                                                                    <td class="text-center"> 
                                                                        <%= tipocontratoLL.getId_tipo_contrato()%>
                                                                    </td>
                                                                    <td class="text-center"> 
                                                                        <%= tipocontratoLL.getDescrip()%>
                                                                    </td>    
                                                                    <td class="text-center"> 
                                                                        <%= tipocontratoLL.getEstado_tipo()%>
                                                                    </td> 

                                                                    <td class="text-center">
                                                                        <div class="container-fluid margin">
                                                                            <form action="tipocontrato" method="POST">  <%-- ubicar el form  action de forma que todo lo que se quiere hacer este afectado, con sus inputs --%>
                                                                                <input type="hidden" name="codigo" value="<%= tipocontratoLL.getId_tipo_contrato()%>"> 
                                                                                <input type="submit" name="accion" target="_blank" class="btn btn-light action-button" value="Cambiar Inactivo">
                                                                                <input type="hidden" name="codigo2" value="<%= tipocontratoLL.getId_tipo_contrato()%>">
