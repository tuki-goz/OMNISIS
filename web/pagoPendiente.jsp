<%-- 
    Document   : pagoPendiente
    Created on : 02/11/2021, 12:50:23 PM
    Author     : Alvaro
--%>
...
<html>
    ...
    <body>
        ...
        <%@ page import="controller.pago"%>

        <%
            ArrayList<Cta_Pagar> AA = null;
            AA = (ArrayList<Cta_Pagar>) request.getAttribute("Cta_PagarL");
        %>  
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        <div class="page-header-title">
                                            <h3 class="m-b-10">Listado de Pagos Pendientes</h3>
                                        </div>                                        
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="card">
                                            <div class="card-header">
                                                <form action="pago" method="POST">
                                                    <input id="card-holder" type="text" name="buscartxt" class="form-control" placeholder="Buscar por nombre del proveedor" aria-label="Card Holder" aria-describedby="basic-addon1">
                                                    <br>      
                                                    <input type="submit" name="accion" target="_blank" class="btn btn-light action-button" value="Buscar"> 
                                                    <input type="hidden" name="buscartxt" value=""> 
                                                    <input type="submit" name="accion" target="_blank" class="btn btn-send action-button" value="Pagos Realizados">
                                                </form>                                      
                                            </div> 
                                            <div>
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        <td class="text-center"> 
                                                                            <%= ctapagarLL.getId_cuenta_pagar()%>
                                                                        </td>
                                                                        <td class="text-center"> 
                                                                            <%= ctapagarLL.getCodigo_cuenta_pagar()%>
                                                                        </td>                                          
                                                                        <td class="text-center"> 
                                                                            <%= ctapagarLL.getDescripcion_cuenta_pagar()%>
                                                                        </td>                                 
                                                                        <td class="text-center"> 
                                                                            <%= ctapagarLL.getCondicion_cuenta_pagar()%>
                                                                        </td>                                 
                                                                        <td class="text-center"> 
                                                                            <%= ctapagarLL.getFecha_vencimiento_cuenta_pagar()%>
                                                                        </td>
                                                                        <td class="text-center"> 
                                                                            <%= ctapagarLL.getTotal_cuenta_pagar()%>
                                                                        </td>                                          
                                                                        <td class="text-center"> 
                                                                            <%= ctapagarLL.getEstado_cuenta_pagar()%>
                                                                        </td>                            
                                                                        ...
                                                                        <td class="text-center">
                                                                            ...
                                                                            <div class="container-fluid margin">
                                                                                <form action="pago" method="POST"> 
                                                                                    <input type="hidden" name="codigo2" value="<%= ctapagarLL.getId_cuenta_pagar()%>">
                                                                                    <input type="submit" name="accion" target="_blank" class="btn btn-warning action-button" value="Pagar">
                                                                                </form>
                                                                            </div> 
                                                                        </td> 
                                                                        <% } %>
