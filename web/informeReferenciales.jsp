...
<html>
    <head>
        <title>Informe de Archivos Referenciales</title>
    ...
    <body>
        ...
        <%@ page import="model.InformeReferenciales, java.util.ArrayList"  %>
        <%@ page import="controller.informeReferenciales"  %>


        <%
            ArrayList<InformeReferenciales> AA = null;
            AA = (ArrayList<InformeReferenciales>) request.getAttribute("InformeReferencialesL");
        %>  
        <%
            InformeReferenciales infref;
            infref = (InformeReferenciales) request.getAttribute("InformeReferenciales");
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        <div class="page-header-title">
                                            <h3 class="m-b-10">Informe de Archivos Referenciales</h3>
                                        </div>                                        
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-xl-12">
                                        <div class="card">
                                            <div class="card-header">
                                                <hr>
                                                <div class="col-6">
                                                    <form name="form1" action="pdfFuncionario.jsp" target="_blank" method="post"> 
                                                        <div class="input-group">
                                                            <input type="submit" name="btn1" target="_blank" class="btn btn-success action-button" value="Informe de Funcionarios">
                                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                        ...
                                                        <input type="text" name="txtparametro" value="<%= Variables.usuarioConectado.getNumero_usuario()%>" style="color: white; border: none;">                                                          
                                                    </form>
                                                </div>
                                                <hr>
                                                <br>
                                                <br> 
                                                <div class="col-6">
                                                    <form name="form1" action="pdfProveedor.jsp" target="_blank" method="post"> 
                                                        <div class="input-group">                                                           
                                                            <input type="submit" name="btn1" target="_blank" class="btn btn-success action-button" value="Informe de Proveedores">
                                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                ...
                                                <br> 
                                                <div class="col-6">
                                                    <form name="form1" action="pdfCliente.jsp" target="_blank" method="post"> 
                                                        <div class="input-group">                                                         
                                                            <input type="submit" name="btn1" target="_blank" class="btn btn-success action-button" value="Informe de Clientes">
                                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                    ...
                                                    <nav class="navbar navbar-dark navbar-expand-md navigation-clean-search">
                                                        <ul class="nav navbar-nav">
                                                            <li class="dropdown">
                                                                ...
                                                                <input  type="hidden" name="txtprueba" class="form-control" aria-label="Card Holder" aria-describedby="basic-addon1"    id="descri" value="<%= infref.getNom_fun()%>">
                                                            </li>                                                                        
