                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        <div class="page-header-title">
                                            <h1 class="m-b-10">Registrar nuevo departamento</h1>
                                        </div>
                                        <div class="page-header-title">
                                            <h5 class="m-b-10"></h5>
                                        </div>
                                                ...
                                                <form action="departamento" method="POST">
                                                    <div class="row">
                                                        <div class="col-3 text-center">
                                                            ...
                                                            <% if (dep.getDescripcion_dep() != null) {%>  <%--para sacar null--%>
                                                            <input id="card-holder" type="text" name="descriptxt" class="form-control" placeholder="Nombre del departamento" aria-label="Card Holder" aria-describedby="basic-addon1" pattern="[[A-Z]{0,}[a-z]{0,}\D{1,}" id="descri" value="<%=dep.getDescripcion_dep()%>">
                                                            <%  } else {%>
                                                            <input id="card-holder" type="text" name="descriptxt" class="form-control" placeholder="Nombre del departamento" aria-label="Card Holder" aria-describedby="basic-addon1" pattern="[[A-Z]{0,}[a-z]{0,}\D{1,}" id="descri" value="">
                                                            <% }%>                                    
                                                            <input id="card-holder" type="hidden" name="idtxt" class="form-control" aria-label="Card Holder" aria-describedby="basic-addon1" value="<%= dep.getId_dep()%>">  
                                                        </div>
                                                        <div class="col-3 text-center">
                                                            <label for="card-holder" class="text-capitalize">Estado</label> 
                                                            <div class="custom-control custom-radio">
                                                                <% if (dep.getEstado_dep() == "activo") {%>
                                                                <div class="custom-control custom-radio">
                                                            ...
                                                            <select id="drop_pais" name="drop_pais" class="form-control" onChange="update()" >
                                                                <%
                                                                    ...
                                                                    for (String i : drop.keySet()) {
                                                                        if (dep.getDescripcion_pais() != null) {
                                                                            if (drop.get(i).toString().equals(dep.getDescripcion_pais().toString())) {
